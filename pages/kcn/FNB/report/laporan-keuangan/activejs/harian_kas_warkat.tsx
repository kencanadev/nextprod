...
const ReportPage = () => {
    ...
    useEffect(() => {
        dispatch(setPageTitle('Laporan Harian kas dan warkat'));
    });
    ...
    return (
        <div style={{ width: '100%', height: '100vh' }}>
            <Viewer reportUri="/report/transaksi/laporan/laporan_keuangan//harian_kas_warkat.rdlx-json" reportParam={parameters} />
