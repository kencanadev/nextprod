...
const ReportPage = () => {
    ...
    useEffect(() => {
        dispatch(setPageTitle('Laba Rugi Devisi Penjualan'));
    });
    ...
    return (
        <div style={{ width: '100%', height: '100vh' }}>
            <Viewer reportUri="/report/transaksi/laporan/laporan_keuangan//lr_divisi_penjualan.rdlx-json" reportParam={parameters }  hiddenPrint={allowPrint} />
