...
const ReportPage = () => {
    ...
    useEffect(() => {
        dispatch(setPageTitle('Form Neraca Standar'));
    });
    ...
    return (
        <div style={{ width: '100%', height: '100vh' }}>
            <Viewer reportUri="/report/transaksi/laporan/laporan_keuangan//rpNeracaSkontro.rdlx-json" reportParam={parameters} hiddenPrint={allowPrint} />
