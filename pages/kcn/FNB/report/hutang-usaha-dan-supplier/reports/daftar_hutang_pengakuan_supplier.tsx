...
const ReportPage = () => {
    ...
    useEffect(() => {
        ...
        const param1 = params.get('tglAwal');
        const param2 = params.get('tglAkhir');
        const param3 = params.get('kodeSupp');
        const param4 = params.get('noLpb');
    ...
    useEffect(() => {
        dispatch(setPageTitle('Laporan Daftar Pengakuan Hutang'));
    });
    ...
    return (
        <div style={{ width: '100%', height: '100vh' }}>
            <Viewer reportUri="/report/laporan//hutang-usaha-dan-supplier/daftar_hutang_pengakuan_supplier.rdlx-json" reportParam={parameter} hiddenPrint={allowPrint} />
        </div>
    );
};
