...
const ReportPage = () => {
    ...
    useEffect(() => {
        dispatch(setPageTitle('Aging Hutang Warkat'));
    });
    ...
    return (
        <div style={{ width: '100%', height: '100vh' }}>
            <Viewer reportUri="/report/laporan//hutang-usaha-dan-supplier/rekapitulasi_hutang_warkat_byUmur.rdlx-json" reportParam={parameter} hiddenPrint={allowPrint} />
        </div>
    );
};
