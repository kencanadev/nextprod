...
const PostingTtpList = () => {
    ...
    const clickDaftarMutasi = (args: any) => {
        ...
        setListStateData((prevState) => ({
            ...
            // nilaiTransfer: args.dibayar, di remak 03/50/2025
            // nilaiTransfer: parseFloat(args.pembulatan) > 0 ? String(parseFloat(args.dibayar) + parseFloat(args.pembulatan)) : args.dibayar,
            // nilaiTransfer: String(parseFloat(args.dibayar) + parseFloat(args.pembulatan)), di remak 03/50/2025 pas ada kasus api id nya ga masuk pembulatan
            nilaiTransfer: String(parseFloat(args.jumlah)),
                        ...
                        <TooltipComponent content="Tampilkan filter data" opensOn="Hover" openDelay={1000} target="#btnFilter">
                            <TooltipComponent content="Edit data penerimaan piutang" opensOn="Hover" openDelay={1000} target="#btnEdit">
                                <TooltipComponent content="Hapus data penerimaan piutang" opensOn="Hover" openDelay={1000} target="#btnApproval">
                                    ...
                                    {userid === 'administrator' || entitas === '899' ? (
                                        <ButtonComponent
                                            id="btnApproval"
                                            cssClass="e-primary e-small"
