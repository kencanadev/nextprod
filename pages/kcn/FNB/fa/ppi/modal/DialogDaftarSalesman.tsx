...
const DialogDaftarSalesman: React.FC<DialogDaftarSalesmanProps> = ({
    ...
    React.useEffect(() => {
            if (gridDaftarSalesman) {
                gridDaftarSalesman.dataSource = stateDataHeader?.searchKeywordNoSales || stateDataHeader?.searchKeywordNamaSales ? filteredDataSalesman : dataDaftarSalesman;
                gridDaftarSalesman.refresh();
            }
        }, [dataDaftarSalesman, filteredDataSalesman, stateDataHeader?.searchKeywordNoSales, stateDataHeader?.searchKeywordNamaSales]);
