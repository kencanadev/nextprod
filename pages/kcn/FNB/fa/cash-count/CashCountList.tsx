...
const CashCountList = () => {
    ...
    const refreshData = async (fetch_awal = false) => {
        ...
        let param3 = checkboxState.kode_akun ? filterState.kode_akun : 'all';

        console.log('param3', param3, filterState, checkboxState);
...
${
 ...
 <tr style="font-size: 8pt" class="section-pengeluaran">
     ...
     <table style="width: 100%">
             ...
             `
                 ...
                 <td colspan="7">
                     ...
                     <tr>
                             ...
                             <td style="width:165px; "></td>
                             <td style="width:120px; border-top: 1px solid black" class="text-right">${formatNumber(SpreadNumber(totalWarkat))}</td>
        ...
        `
           ...
           <tr style="font-size: 8pt">
            ...
            <td class="text-right" style="font-weight:bold">${formatNumber(SpreadNumber(totalPenerimaan))}</td> 
            <td>
            </td>
           </tr>
           </tfooter>
     ...
     <tr class="section-pengeluaran">
         ...
         <td  class="text-right">${formatNumber(SpreadNumber(totalWarkat)) == 0 ? '' : formatNumber(SpreadNumber(totalWarkat))}</td>
 </tr>
     `
        : ''
}
        ...
        hasKr2
         ...
         <table style="width: 100%">
           ...
           <tr style="font-size: 8pt">
            ...
            <td class="text-right" style="font-weight:bold">${formatNumber(SpreadNumber(totalPengeluaran))}</td> 
            <td>
            </td>
           </tr>
           </tfooter>
         ...
         `
           ...
           <tr style="border-bottom: 1px dotted black;  font-size: 8pt; ">
                ...
                <td class="text-right" style="font-weight:bold">${formatNumber(SpreadNumber(saldoAkhir))}</td>
            </tr>
           ${
