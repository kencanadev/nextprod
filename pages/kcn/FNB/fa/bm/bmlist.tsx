...
const BmList = () => {
    ...
    const isEditDisabled = selectedRowStatus === 'approved' ? !((userMenu.edit === 'Y' && entitas_user === '899') || userid.toLowerCase() === 'administrator') : false;
            ...
            <div style={{ minHeight: '40px', marginTop: '-3px', marginBottom: '11px', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                <div className="flex flex-wrap items-center">
                    ...
                    <ButtonComponent
                        id="btnBatal"
                        cssClass="e-primary e-small"
                        style={entitas_user === '899' || userid.toLowerCase() === 'administrator' ? styleButton : { ...styleButtonDisabled, color: '#1c1b1f61' }}
                        disabled={entitas_user === '899' || userid.toLowerCase() === 'administrator' ? false : true}
                    ...
                    {!isPajak && (
                        <ButtonComponent
                            id="approvalBM"
                            cssClass="e-primary e-small"
                            style={entitas_user === '899' || userid.toLowerCase() === 'administrator' ? styleButtonApproval : styleButtonApprovalDisabled}
                            disabled={entitas_user === '899' || userid.toLowerCase() === 'administrator' ? false : true}
                            onClick={() => {
                                if (selectedRowStatus === 'approved') {
                                    setisApprovedData('N');
