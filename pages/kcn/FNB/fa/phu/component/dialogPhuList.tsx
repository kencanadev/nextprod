...
import { cekDataDiDatabase, cekNoDokTerakhir } from '@/utils/global/fungsi';

enableRipple(true);

interface dialogPhuListProps {
    userid: any;
    kode_entitas: any;
...
const DialogPhuList: React.FC<dialogPhuListProps> = ({
    userid,
    kode_entitas,
    masterKodeDokumen,
    masterDataState,
                    ...
                    <div className="col-xs-6 col-sm-6 col-lg-6 col-md-6" style={{ paddingRight: '20px' }}>
                        ...
                        {/* <TextBoxComponent
                            ...
                            blur={(d: ChangeEventArgsInput) => {
                                ...
                                noFbRef.current = args.no_fb;
                                perhitunganAlokasiDana(inputRef.current, noFbRef.current);
                                // actionCompleteDetailBarang(args.no_fb, value);
                            }}
                            // value="0"
                            onFocus={(args: any) => {
                                args.target.select();
        ...
        if (kode_entitas !== null || kode_entitas !== '') {
            try {
                ...
                if (masterDataState == 'BARU') {
                    ...
                    const resultListEditPHUMaster: any[] = await ListEditPHUMaster(kode_entitas, 'IDR', masterKodeDokumen, selectedKodeSupp, 'P');
                    const resultListEditPHUDetail: any[] = await ListEditPHUDetail(kode_entitas, 'IDR', masterKodeDokumen, selectedKodeSupp, 'P');
                    const resultListEditPHUJurnal: any[] = await ListEditPHUJurnal(kode_entitas, 'IDR', masterKodeDokumen, selectedKodeSupp, 'P');
                    ...
                    const jurnal = await resultListEditPHUJurnal.map((item: any) => {
                        return {
                            ...
                            // catatan: modalJenisPembayaran === 'Transfer' && kode_entitas === '899' ? stateDataHeader?.noBuktiTransfer+' atas : '+stateDataHeader?.namaSupplierValue : stateDataHeader?.namaHutang + ' atas : ' + stateDataHeader?.namaSupplierValue,
    ...
    const handleTemplatePilih = async (event: any, args: any) => {
        ...
        const noFb = args.no_fb;
        const jumlahPembayaran = parseFloat(args.jumlah_pembayaran);
        // const noFb = (document.getElementsByName('no_fb')[0] as HTMLFormElement).value;
        // let jumlahPembayaran = parseFloat((document.getElementsByName('jumlah_pembayaran')[0] as HTMLFormElement).value);
        ...
        const newNodes = await dataBarang.nodes.map((node: any) => {
            if (node.no_fb === noFb) {
                ...
                if (isCheck === true) {
                    ...
                    sisaPembayaran = parseFloat(node.sisa) + jumlahPembayaran;
                    setStateDataHeader((prevState: any) => ({
                        ...prevState,
                        disabledResetPembayaran: true,
                    }));
        ...
        if (dataSourceJurnal.length <= 0 && dataBarang.nodes.length > 0) {
            ...
            if (resultTglMinusSatu === false) {
                const result = await withReactContent(swalDialog).fire({
                    title: '<p style="font-size:12px">Tanggal lebih kecil dari hari ini, transaksi PHU akan dilanjutkan.</p>',
                    width: '24%',
                    target: '#dialogPhuList',
                    showCancelButton: true,
            ...
            // console.log('masterDataState 0 = ', generateCounterNu);
            ...
            if (masterDataState === 'BARU') {
                ...
                if (status === true) {
                    ...
                    const auditResponse = await axios.post(`${apiUrl}/erp/simpan_audit`, {
                        ...
                        proses: 'NEW',
                        diskripsi: `Pembayaran Hutang tunai nilai transaksi = ${frmNumber(stateDataHeader?.jumlahBayar)}`,
    ...
    return (
        <div>
                                ...
                                <div className="panel-tabel" style={{ width: '100%' }}>
                                    <div className="flex">
                                        <div style={{ width: '40%' }}>
                                            ...
                                            <div className="flex" style={{ alignItems: 'center' }}>
                                                <label style={{ width: '23.5%', textAlign: 'right', marginRight: 6 }}>Akun Kredit</label>
                                                <input
                                                    className={` container form-input`}
                                                    onChange={(event) =>
                                                        HandleModalInput(
                                        ...
                                        <div className="border p-3" style={{ backgroundColor: '#eeeeee', borderRadius: 6, width: '20%', height: 147 }}>
                                    ...
                                    <div className="flex" style={{ marginBottom: 5 }}>
                                        <div style={{ width: '81%', height: 58, marginBottom: '5%' }}>
                                            <div className="flex" style={{ alignItems: 'center', marginTop: -4 }}>
                                                <label style={{ width: '16.1%', textAlign: 'right', marginRight: 6 }}>Supplier</label>
                                                <input
                                                    className={` container form-input`}
                                                    onChange={(event) =>
                                                        HandleModalInputSupplier(
                                                    ...
                                                    style={{ borderRadius: 2, fontSize: 11, marginTop: 1, marginLeft: 0, borderColor: '#bfc9d4', width: '13.6%' }}
                                                ...
                                                <input
                                                    ...
                                                    style={{ borderRadius: 2, fontSize: 11, marginTop: 1, marginLeft: 0, borderColor: '#bfc9d4', width: '34.5%' }}
                                                ...
                                                {(stateDataHeader?.noAkunValue === '1-11002' && kode_entitas == 300) || kode_entitas != 300 ? (
                                                    <>
                                                        <label style={{ width: '11%', textAlign: 'right', marginRight: 6 }}>No. Kontrak</label>
                                                        <input
                                                            className={` container form-input`}
                                                            style={{ borderRadius: 2, fontSize: 11, marginTop: 4, marginLeft: 0, borderColor: '#bfc9d4', width: '58%' }}
                                            ...
                                            <div className="flex" style={{ alignItems: 'center' }}>
                                                ...
                                                <textarea disabled={true} style={{ marginTop: 2, width: '86.4%', height: 54, backgroundColor: '#eeeeee', border: '1px solid #bfc9d4' }}></textarea>
                                            </div>
                                    ...
                                    <div className="e-content">
                                        <div style={{ width: '100%', height: '100%', marginTop: '5px' }} tabIndex={0}>
                                            ...
                                            <GridComponent
                                                ...
                                                editSettings={{ allowAdding: plag !== 'bukuBesar', allowEditing: plag !== 'bukuBesar', allowDeleting:plag !== 'bukuBesar', newRowPosition: 'Bottom' }}
            ...
            <DialogDaftarUangMuka
                ...
                stateDataHeader={stateDataHeader}
                // buttonDaftarUangMuka={buttonDaftarUangMuka}
                // gridDaftarUangMuka={gridDaftarUangMuka}
                setStateDataHeader={setStateDataHeader}
                dataDaftarUangMuka={dataDaftarUangMuka}
                // handleClickDaftarUangMuka={handleClickDaftarUangMuka}
                swalToast={swalToast}
            ...
            <DialogDaftarCustomer
                ...
                stateDataDetail={stateDataDetail}
                // buttonDaftarCustomer={buttonDaftarCustomer}
                // gridDaftarCustomer={gridDaftarCustomer}
                setStateDataDetail={setStateDataDetail}
