...
import { useFppHandlerContextFnB } from '@/context/fpp/FppHandlerProviderFnB'
...
const NotaAsliCheckbox = (args: any) => {
    ...
    const { setTriggerData } = useFppHandlerContextFnB();
...
const TemplateTombol = (args: any) => {
    ...
    const { loadImage, deleteImage, handleFileSelect, setShowDialogUpload, setImageFile, setMasterData } = useFppHandlerContextFnB();
    const alertDelete = () => {
        swal.fire({
            icon: 'question',
            html: `
...
const FppList = () => {
    ...
    const fetchData = async () => {
        ...
        try {
            ...
            const modifiedData =
                userid === 'administrator' || entitas_user === '899'
                                    ...
                                    <ColumnsDirective>
                                        ...
                                        <ColumnDirective
                                            columns={[
                                                ...
                                                { field: 'cek_nota_coret', headerText: 'Cek', headerTextAlign: 'Center', textAlign: 'Left', width: 50, minWidth: 30, template: templateNotaCoret },
