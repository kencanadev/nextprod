...
interface DialogListVendorProps {
  isOpen: boolean;
  onClose: () => void;
  handlePilihVendor: () => void;
  pencarianSupplier: (e: any, a: any) => void;
  setSelectedSupplier: any;
  dataSource: any;
}

const DialogListVendor: React.FC<DialogListVendorProps> = ({ isOpen, onClose, handlePilihVendor, pencarianSupplier, setSelectedSupplier, dataSource }) => {
...
export default DialogListVendor;
