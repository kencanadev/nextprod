...
const TanggalTemplate = (props: any, refreshData: any) => {
  ...
  return (
    <div className="flex items-center justify-between">
      <DatePickerComponent
        locale="id"
        style={{ fontSize: '12px', padding: '0 !important', color: color }}
    ...
    <div className="h-full">
      ...
      >
        <ColumnsDirective>
          ...
          />
          <ColumnDirective field="nota" headerText="Catatan" headerTextAlign="Center" textAlign="Left" width="150" clipMode="EllipsisWithTooltip" />
        </ColumnsDirective>
