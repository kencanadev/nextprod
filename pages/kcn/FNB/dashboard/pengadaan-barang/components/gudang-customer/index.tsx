      ...
      <div className="relative flex h-[calc(100vh-180px)]">
        ...
        <div className="h-full flex-1 overflow-auto">
          <GridComponent {...gridOptions} rowSelected={handleRowSelected} recordDoubleClick={handleRecordDoubleClick} dataSource={data} queryCellInfo={queryCellInfo}>
            <ColumnsDirective>
              <ColumnDirective field="nama_relasi" headerText="Customer" width="140" headerTextAlign="Center" textAlign="Left" clipMode="EllipsisWithTooltip" />
              ...
              <ColumnDirective field="stok" headerText="Jumlah Stok" width="140" headerTextAlign="Center" textAlign="Right" clipMode="EllipsisWithTooltip" />
              <ColumnDirective field="tgl_do" headerText="Tgl. DO" width="140" headerTextAlign="Center" textAlign="Left" clipMode="EllipsisWithTooltip" />
              <ColumnDirective field="tgl_fj" headerText="Tgl. Faktur" width="140" headerTextAlign="Center" textAlign="Left" clipMode="EllipsisWithTooltip" />
              <ColumnDirective field="umur" headerText="Umur Stok" width="140" headerTextAlign="Center" textAlign="Right" clipMode="EllipsisWithTooltip" />
            </ColumnsDirective>
            <AggregatesDirective>
              <AggregateDirective>
                <AggregateColumnsDirective>
