...
const GridTTB = ({ gridTTB }: { gridTTB: any }) => {
    return (
        <GridComponent
            id="gridTTB"
            locale="id"
        ...
        >
            <ColumnsDirective>
                ...
                <ColumnDirective
                    ...
                    clipMode="EllipsisWithTooltip"
                />
                <ColumnDirective allowEditing={false} field="kode" headerText="Kode" headerTextAlign="Center" textAlign="Center" width="80" clipMode="EllipsisWithTooltip" />
                <ColumnDirective allowEditing={false} field="nama_relasi" headerText="Customer" headerTextAlign="Center" textAlign="Center" width="250" clipMode="EllipsisWithTooltip" />
