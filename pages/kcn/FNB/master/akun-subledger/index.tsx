        ...
        <>
            <div className={`Main`} id="daftarAkunSubledger">
                ...
                <div className="relative flex h-full gap-1 sm:h-[calc(100vh_-_150px)]">
                    {panelVisible && (
                        <div
                            className={`panel absolute z-10 hidden h-full w-[300px] max-w-full flex-none space-y-4 p-4 xl:relative xl:block xl:h-auto ltr:rounded-r-none ltr:xl:rounded-r-md rtl:rounded-l-none rtl:xl:rounded-l-md ${
