...
import { ColumnDirective, ColumnsDirective, GridComponent, Inject, RowDataBoundEventArgs, Sort } from '@syncfusion/ej2-react-grids';
    ...
    useEffect(() => {
        ...
        const fetchAKun = async () => {
            try {
                ...
                // const data = await fetchAkunData(entitas, token);
                // // setDataAkun(data);
                // setLoading(false);
                // gridAkun.current?.refresh();
            } catch (error) {
        ...
        >
            <div className="relative block  rounded-lg border border-gray-100 bg-white  dark:border-gray-800 dark:bg-gray-800">
                <div className={`${loading && 'opacity-20'}`}>
                    ...
                    >
                        <ColumnsDirective>
                            <ColumnDirective template={(props: any) => TextTemplate(props, 'no_akun')} field="no_akun" headerText="No. Akun" headerTextAlign="Center" width={170} />
                            <ColumnDirective template={(props: any) => TextTemplate(props, 'nama_akun')} field="nama_akun" headerText="Keterangan" headerTextAlign="Center" />
                        </ColumnsDirective>
