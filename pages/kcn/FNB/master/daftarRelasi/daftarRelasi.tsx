...
const RelasiList = () => {
    ...
    return (
        <div className="Main h-[calc(100vh-220px)] " id="main-target">
            ...
            {/*==================================================================================================*/}
            <div className="mb-2 flex min-h-[30px] w-full justify-between 2xl:min-h-[48px]">
                <div className="flex gap-2">
                    ...
                    <button
                        id="btnFilter"
                        type="submit"
                        className={`btn btn-primary mb-2 md:mb-0 md:mr-2 cursor-pointer ${isShowTaskMenu ? 'opacity-50' : ''}`}
            ...
            <div className="flex h-full w-full flex-grow gap-2">
                <div className={`box-border min-w-[300px] rounded-md   p-3 ${isShowTaskMenu ? '!block' : 'hidden'}`} style={{ background: '#dedede' }}>
                    <div className="flex h-full flex-col px-2 pb-16 pt-2 ">
                        <div className="pb-5">
                            <div className="relative flex items-center text-center">
                                <button className="absolute right-0 top-0 p-2 text-gray-600 hover:text-gray-900" onClick={() => setIsShowTaskMenu(false)}>
                        ...
                        <form className="flex h-full flex-col gap-6">
                            <div>
                                <label className="mt-3 flex cursor-pointer items-center">
                                    <input type="checkbox" name="no_register" className="form-checkbox" checked={isNoRegisterChecked} onChange={() => setIsNoRegisterChecked(!isNoRegisterChecked)} />
                                    <span>No. Register</span>
                                </label>
                                <input type="text" placeholder="--- No. Register ---" className="form-input" name="no_register" value={noRegisterValue} onChange={handleNoRegisterInputChange} />
                                <label className="mt-3 flex cursor-pointer items-center">
                                    <input placeholder="" type="checkbox" className="form-checkbox" checked={isNamaRelasiChecked} onChange={() => setIsNamaRelasiChecked(!isNamaRelasiChecked)} />
                ...
                <div className="h-full w-full overflow-x-auto overflow-y-auto rounded-md bg-[#dedede] p-2 ">
