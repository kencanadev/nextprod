        ...
        <div className="flex h-screen flex-col" id="fpmbList">
            ...
            <div className="flex w-full flex-grow">
                <div className="w-full">
                    ...
                    <div className="mb-4 rounded-md bg-white p-4 shadow-md">
                        <div className="mb-2 items-center justify-between border-b pb-2 md:flex">
                            <div className="flex gap-x-3">
                                <div className="flex space-x-2">
                                    <div className="grid grid-cols-12">
                                        <div className="col-span-3 mt-1 bg-gray-100 p-4"></div>
                                    </div>
                                ...
                                {/* <div className="flex space-x-2">
                                    <input type="text" placeholder="<Pencarian Data List>" className="rounded border px-4 py-2" />
            ...
            <div className="relative flex h-full gap-3 sm:h-[calc(100vh_-_100px)]">
                ...
                <div className="h-full flex-1 overflow-auto">
                    ...
                    {/*  */}
                    <div
                        className={`panel bg-white-200/50 absolute z-10 mb-2 hidden h-auto w-[300px] max-w-full flex-none rounded-md p-4 shadow-md dark:border-[#191e3a] xl:relative xl:block xl:h-auto ltr:rounded-r-none ltr:xl:rounded-r-md rtl:rounded-l-none rtl:xl:rounded-l-md`}
