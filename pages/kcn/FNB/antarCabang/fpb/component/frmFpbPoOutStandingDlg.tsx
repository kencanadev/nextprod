...
interface FrmFpbPoOutStandingProps {
    isOpen: boolean;
    onClose: any;
    onBatal: any;
    selectedData: any;
...
const FrmFpbPoOutStanding = ({ isOpen, onClose, onBatal, selectedData, target, stateDokumen, kode_entitas_pusat, kode_item, diskripsi }: FrmFpbPoOutStandingProps) => {
            ...
            >
                <ColumnsDirective>
                    ...
                    <ColumnDirective
                        // template={(args: any) => TemplateNamaAkun(args)}
                        field="tgl_kirim"
                        headerText="Tgl. Estimasi Dikirim"
                        headerTextAlign="Center"
                        textAlign="Left"
                        width="60"
                        clipMode="EllipsisWithTooltip"
...
export default FrmFpbPoOutStanding;
