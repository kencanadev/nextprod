...
const FrmItemDlg = ({ isOpen, onClose, onBatal, selectedData, target, stateDokumen }: FrmItemDlgProps) => {
    ...
    const fetchDataBarang = async () => {
        try {
            const response = await axios.get(`${apiUrl}/erp/list_barang_fpb`, {
                params: {
