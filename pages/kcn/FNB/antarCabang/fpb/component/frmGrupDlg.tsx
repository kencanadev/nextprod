...
const FrmGrupDlg = ({ isOpen, onClose, onBatal, selectedData, target, stateDokumen }: FrmGrupDlgProps) => {
    ...
    const fetchDataBarang = async () => {
        try {
            ...
            dgGrup.dataSource = resultFetchDataBarang;
