...
interface FrmTerminDlgCabangProps {
    isOpen: boolean;
    onClose: any;
    onBatal: any;
    selectedData: any;
...
const FrmTerminDlgCabang = ({ isOpen, onClose, onBatal, selectedData, target, stateDokumen }: FrmTerminDlgCabangProps) => {
...
export default FrmTerminDlgCabang;
