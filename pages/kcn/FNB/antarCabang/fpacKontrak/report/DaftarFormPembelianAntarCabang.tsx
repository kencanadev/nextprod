...
const ReportPage = () => {
    ...
    useEffect(() => {
        dispatch(setPageTitle('Daftar Form Pengadaan Barang'));
    });
    return (
        <div style={{ width: '100%', height: '100vh' }}>
            <Viewer reportUri="/report/transaksi/antarCabang/FPAC_kontrak/daftar_fpac_kontrak.rdlx-json" reportParam={parameter} />
        </div>
    );
};
