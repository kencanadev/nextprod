...
const FPACList = () => {
  ...
  const handleNavigateLink = (jenis: any) => {
    ...
    if (jenis === 'edit') {
      ...
      if (selectedRow) {
        if (selectedData.status_app2 === 'Disetujui') {
          swal.fire({
            title: 'Warning',
  ...
  const refreshData = async () => {
    ...
    try {
      ...
      gridListData.setProperties({ dataSource: formattedData });
    ...
    <div className={`main ${modalHandleDataFPAC ? 'h-[100vh] min-h-[100vh]' : ''}`} id="main-target">
      <div style={{ minHeight: '40px', marginTop: '-3px', marginBottom: '11px', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
        <div className="flex flex-wrap items-center">
          ...
          <ButtonComponent id="btnPembatalanFpac" cssClass="e-primary e-small" style={styleButtonPembatalan} disabled={disabledEdit} content="Pembatalan FPAC" onClick={handlePembatalanFPAC} />
            ...
            <div className="flex flex-col items-center justify-between" id="Candil">
              ...
              <div className="mt-6 flex justify-center">
                <TooltipComponent content="Refresh data yang ditampilkan" opensOn="Hover" openDelay={1000} position="BottomCenter">
                  <ButtonComponent cssClass="e-primary e-small" iconCss="e-icons e-medium e-refresh" content="Refresh Data" style={{ backgroundColor: '#3b3f5c' }} onClick={refreshData} />
                </TooltipComponent>
              </div>
            </div>
          </div>
