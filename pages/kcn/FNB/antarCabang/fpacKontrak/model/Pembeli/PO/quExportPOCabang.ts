...
export const createPOPembeliPayload = async (editData: any, kode_entitas: any, token: any, tgl: any, termin: any, updateState: any, tipe: string) => {
  ...
  const payload: any = {
    ...
    netto_mu: parseFloat(editData.netto_mu),
    total_rp: parseFloat(editData.total_rp),
    ...
    netto_rp: parseFloat(editData.netto_rp),
