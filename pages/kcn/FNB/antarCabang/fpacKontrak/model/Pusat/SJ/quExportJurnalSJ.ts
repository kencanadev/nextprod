...
export const createJurnalSJPusatPayload = async (editData: any, kode_entitas: string, token: string, hargaBeliMu: number) => {
  ...
  const payload1 = {
    ...
    debet_rp: sNilaiJurnalSj,
    kredit_rp: 0,
    jumlah_rp: sNilaiJurnalSj,
    jumlah_mu: sNilaiJurnalSj / 1,
  ...
  const payload2 = {
    ...
    kurs: parseFloat(editData.kurs),
    debet_rp: 0,
    kredit_rp: sNilaiJurnalSj,
    jumlah_rp: -1 * sNilaiJurnalSj,
    jumlah_mu: -1 * (sNilaiJurnalSj / 1),
