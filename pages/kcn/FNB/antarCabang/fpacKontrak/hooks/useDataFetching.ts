...
export const useDataFetching = (editData: any, kode_entitas: string, token: string, updateState: any, hargaBeliMu: number, hargaJualMu: number, tipe: string) => {
  // Pembeli
    ...
    const fetchAllData = async () => {
      try {
        ...
        const [
          ...
          // Pembeli
          createFBPembeliPayload(editData, kode_entitas, tgl, terminBeli, token, updateState, tipe),
          createDetailFBPembeliPayload(editData, kode_entitas, token),
          createPBPembeliPayload(editData, tgl, terminBeli, kode_entitas, token, updateState, tipe),
          createDetailPBPembeliPayload(editData, kode_entitas, token),
          createJurnalPBPembeliPayload(editData, kode_entitas, token),
          createPOPembeliPayload(editData, kode_entitas, token, tgl, terminBeli, updateState, tipe),
          createDetailPOPembeliPayload(editData, kode_entitas, token),
          ...
          createDetailFJPenjualPayload(editData, hargaJualMu, token),
          ...
          createFJPusatPayload(editData, tgl, terminPusat, kode_entitas, token, updateState, tipe),
          createDetailFJPusatPayload(editData, hargaBeliMu),
          createJurnalFJPusatPayload(editData, kode_entitas, token),
          createSPMPusatPayload(editData, kode_entitas, token, updateState, tipe),
          createDetaiSPMPusatPayload(editData, kode_entitas, token),
          createSOPusatPayload(editData, kode_entitas, token, terminPusat, updateState, tipe),
          createDetailSOPusatPayload(editData, kode_entitas, token),
          createSJPusatPayload(editData, kode_entitas, token, updateState, tipe),
          createDetailSJPusatPayload(editData, hargaBeliMu),
