    ...
    const refreshData = async () => {
        ...
        try {
            ...
            const transformedData: any[] = responseData.map((item: any) => ({
                ...
                netto_mu:
                    item.netto_mu !== '0.0000'
                        ? parseFloat(item.netto_mu).toLocaleString('en-US', {
        ...
        <div>
            ...
            <div className={styles['flex-container']}>
                                ...
                                <div className="e-content">
                                    ...
                                    >
                                        <ColumnsDirective>
                                            ...
                                            <ColumnDirective field="netto_mu" headerText="Nilai Faktur" headerTextAlign="Center" textAlign="Right" width="110" clipMode="EllipsisWithTooltip" />
                ...
                {modalHist && (
                    ...
                    apiUrl={apiUrl}
                    token={token}
                    selectedRow={dataTerpilih}
                    closeModal={() => setModalHist(false)}
                />
                )}
            </div>
        </div>
