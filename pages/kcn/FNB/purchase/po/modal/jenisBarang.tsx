...
const JenisBarang: React.FC<JenisBarangProps> = ({
    ...
    const handleBuBarangProduksiClick = (id: any) => {
        ...
        if (tipeForm === 'dashboard') {
            router.push({ pathname: '/kcn/FNB/purchase/po/po', query: { str: base64EncodedString, tipe: 'dashboard' } });
        } else {
            router.push({ pathname: '/kcn/FNB/purchase/po/po', query: { str: base64EncodedString } });
        }
    };
            ...
            <Dialog as="div" open={isOpen} onClose={onClose}>
                ...
                <div className="fixed inset-0 z-[999] bg-[black]/60">
                    <div className="flex min-h-screen items-center justify-center px-4">
                        ...
                        >
                            {/* ... Modal Content ... */}
                            <Dialog.Panel className={`panel my-8 w-[35vh] rounded-lg border-0 p-0 text-black dark:text-white-dark`} style={{ maxWidth: '30vh' }}>
