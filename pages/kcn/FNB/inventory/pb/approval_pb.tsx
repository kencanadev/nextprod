                ...
                <div className="flex">
                    ...
                    <button
                        ...
                        onClick={() => {
                            ...
                            // let sNoFBPusat1: any;
                            // let sNoFBPusat: any;
                            // noDokBaru = await generateNU('899', '', '03', moment().format('YYYYMM'));
                            // console.log('noDokBaru ', noDokBaru);

                            // const cekData = await cekDataDiDatabase('899', 'tb_m_fb', 'no_fb', noDokBaru, token);
                            // console.log('cekData ', cekData);
                            // if (cekData) {
                            //     // const cekNoDok = await cekDataDiDatabase(kode_entitas, 'tb_m_ttb_master', 'no_ttb', jsonData?.no_ttb, token);
                            //     // sNoFBPusat = await generateNUDivisi(kode_entitas, defaultNoTtb, divisiPenjualan, '08', moment(date1).format('YYYYMM'), moment(date1).format('YYMM') + `${divisiPenjualan}`);
                            //     sNoFBPusat1 = await generateNU('899', noDokBaru, '03', moment().format('YYYYMM'));
                            //     sNoFBPusat = await generateNU('899', '', '03', moment().format('YYYYMM'));
