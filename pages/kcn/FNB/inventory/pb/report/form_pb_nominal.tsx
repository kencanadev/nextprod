...
const ReportPage = () => {
    ...
    useEffect(() => {
        dispatch(setPageTitle('Form Penerimaan Barang (Dengan Harga)'));
    });
    ...
    return (
        <div style={{ width: '100%', height: '100vh' }}>
            <Viewer reportUri="/report/transaksi/inventory/pb/form_pb_nominal.rdlx-json" reportParam={parameter} />
        </div>
    );
};
