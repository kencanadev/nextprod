...
const DaftarPaket = ({ visible, onClose, selectedRow }: { visible: boolean; onClose: any; selectedRow: any }) => {
    ...
    return (
        <DialogComponent
            id="dialogDaftarPaket"
            isModal={true}
            width={500}
            height={500}
            header={'Daftar Paket ' + selectedRow?.nama_item}
            visible={visible}
            close={onClose}
            showCloseIcon={true}
            target="#main-target"
                ...
                <div className="flex h-[93%] w-full flex-col gap-2">
                    ...
                    >
                        <ColumnsDirective>
                            ...
                            <ColumnDirective field="stok" headerText="Kuantitas" headerTextAlign="Center" textAlign="Left" width={80} />
                        </ColumnsDirective>
