...
const PSList = () => {
    ...
    const [modalPosition, setModalPosition] = useState({ top: '3%', right: '2%', width: '50%', background: '#dedede' });
    ...
    const [selectedTipeDokumenValue, setSelectedTipeDokumenValue] = useState<string | null>('yes');
    ...
    const handleTipeDokumenChange = (value: string) => {
        setSelectedTipeDokumenValue(value);
    };
    ...
    const fetchDataUseEffect = async () => {
        ...
        const formattedResponseData = responseData.map((item) => {
            ...
            return {
                ...item,
                tgl_ps: moment(item.tgl_ps).toDate(),
    ...
    const handleRefreshData = async () => {
        ...
        try {
            let paramObject = {
                ...
                vParam6: isGudangChecked ? selectedOptionGudang : 'all',
                vParam7: 1000,
                vParam8: selectedTipeDokumenValue === 'allTipe' ? 'all' : selectedTipeDokumenValue === 'yes' ? 'Persediaan' : 'Non Persediaan',
            };
    ...
    const handleRowSelected = (args: any) => {
        ...
        const [day, month, year] = moment(args.data.tgl_ps).format('DD-MM-YYYY').split('-');
    ...
    const [modalHandleJenisTransaksi, setModalHandleJenisTransaksi] = useState(false);
    ...
    const handleNavigateLink = async (jenis: any) => {
        ...
        if (yearB < yearA || (yearB === yearA && monthB < monthA)) {
            ...
            if (jenis === 'edit') {
                ...
                // setModalHandleDataPS(true);
                setModalHandleJenisTransaksi(true);
            }
        }
    };

    const [jenisTransaksi, setJenisTransaksi] = useState('');
    const handleNavigateJenisTransaksi = (tipe: any, jenis: any) => {
        vRefreshData.current += 1;
        if (jenis === 'create') {
            setStatusPage('CREATE');
            // setModalHandleDataPS(true);
            ...
            setModalHandleDataPS(true);
            setModalHandleJenisTransaksi(false);
        }
    };
        ...
        <div className="Main" id="main-target">
                            ...
                            <div className="mt-1">
                                ...
                                <div className="flex">
                                    <input
                                        ...
                                        defaultChecked={selectedRadioNilai_adjValue === 'all'}
                                        onChange={() => handleRadioNilai_adjChange('all')}
                                    />
                                    <label htmlFor="ya" className="ml-1" style={{ marginBottom: -2, fontSize: 11 }}>
                                        Semua
                                    </label>
                            ...
                            <div className="mt-1">
                                <div className="flex">
                                    <input
                                        ...
                                        id="yes"
                                        className="form-radio"
                                        defaultChecked={selectedTipeDokumenValue === 'yes'}
                                        onChange={() => handleTipeDokumenChange('yes')}
                                    />
                                    <label htmlFor="yes" className="ml-1" style={{ marginBottom: -2, fontSize: 11 }}>
                                        Persediaan
                                    </label>
                                </div>

                                <div className="flex">
                                    <input type="radio" name="rebuild_stok" id="no" className="form-radio" onChange={() => handleTipeDokumenChange('no')} />
                                    <label htmlFor="no" className="ml-1" style={{ marginBottom: -2, fontSize: 11 }}>
                                        Non Persediaan
                                    </label>
                                </div>

                                <div className="flex">
                                    <input type="radio" name="rebuild_stok" id="allTipe" className="form-radio" onChange={() => handleTipeDokumenChange('allTipe')} />
                                    <label htmlFor="allTipe" className="ml-1" style={{ marginBottom: -2, fontSize: 11 }}>
                                        Semua
                                    </label>
                                </div>
                            </div>
                                        ...
                                        <div className="e-content">
                                            ...
                                            >
                                                <ColumnsDirective>
                                                    ...
                                                    <ColumnDirective field="tipe_dokumen" headerText="Dokumen" width="100" textAlign="Left" headerTextAlign="Center" clipMode="EllipsisWithTooltip" />
                                                    ...
                                                    <ColumnDirective
                                                        field="beban"
                                                        headerText="Pembebanan Karyawan"
                                                        width="140"
                                                        textAlign="Center"
                                                        headerTextAlign="Center"
                                                        template={checkboxTemplateListPS}
                                                    />
                                                    <ColumnDirective
                                                        field="keterangan_tambahan"
                                                        headerText="Keterangan Tambahan"
                                                        width="220"
                                                        textAlign="Left"
                                                        headerTextAlign="Center"
                                                        clipMode="EllipsisWithTooltip"
                            ...
                            <div className="overflow-auto" style={{ maxHeight: '400px' }}>
                                <div style={{ marginBottom: 21 }}>
                                    <span style={{ fontSize: 18, fontWeight: 500 }}>
                                        Detail Penyesuaian dan Rebuild Stok : {dataDetailDokPS.no_ps} - {moment(dataDetailDokPS.tgl_ps).format('DD-MM-YYYY')}
                                    </span>
                                </div>
                                <GridComponent dataSource={detailDok} width={'100%'} rowHeight={30} gridLines={'Both'} allowSorting={true} ref={(g) => (gridListData = g)}>
                                    <ColumnsDirective>
                                        <ColumnDirective field="no_item" headerText="No. Barang" textAlign="Left" headerTextAlign="Center" width="80" />
                                        <ColumnDirective field="nama_item" headerText="Nama Barang" textAlign="Left" headerTextAlign="Center" width="200" />
                                        <ColumnDirective field="satuan" headerText="Satuan" textAlign="Center" headerTextAlign="Center" width="50" />
                                        <ColumnDirective field="qty" format={'N'} headerText="Kuantitas" textAlign="Right" headerTextAlign="Center" width="80" />
                                        <ColumnDirective
                                            field="jumlah_rp"
                                        ...
                                        />
                                        <ColumnDirective field="no_kontrak" headerText="No Kontrak" textAlign="Center" headerTextAlign="Center" width="120" />
                                        <ColumnDirective field="no_mbref" headerText="Refrensi Mutasi Barang" textAlign="Center" headerTextAlign="Center" width="120" />
                                    </ColumnsDirective>
                                ...
                                <GridComponent width={'100%'} dataSource={detailJurnal} gridLines={'Both'} rowHeight={30} allowSorting={true} ref={(g) => (gridListData = g)}>
                                    <ColumnsDirective>
                                        <ColumnDirective field="no_akun" headerText="No. Akun" textAlign="Left" headerTextAlign="Center" width="80" />
                                        <ColumnDirective field="nama_akun" width="200" headerText="Nama" textAlign="Left" headerTextAlign="Center" />
                                        <ColumnDirective
                                            field="debet_rp"
                                            headerText="Debet"
                                            textAlign="Right"
                                        ...
                                        <ColumnDirective
                                            ...
                                            headerTextAlign="Center"
                                        />
                                        <ColumnDirective field="catatan" width="300" headerText="Keterangan" textAlign="Left" headerTextAlign="Center" />
                                        <ColumnDirective field="kode_mu" headerText="MU" textAlign="Center" width="65" headerTextAlign="Center" />
                                        <ColumnDirective field="kurs" headerText="Kurs" textAlign="Center" width="65" headerTextAlign="Center" />
                                        <ColumnDirective
                                            field="jumlah_rp"
                                            headerText="Jumlah"
                                            textAlign="Right"
                                        ...
                                        />
                                        <ColumnDirective field="nama_subledger" width="120" headerText="Subledger" textAlign="Left" headerTextAlign="Center" />
                                        <ColumnDirective field="nama_dept" width="100" headerText="Departmen" textAlign="Left" headerTextAlign="Center" />
                                        <ColumnDirective field="kode_jual" width="80" headerText="Divisi" textAlign="Center" headerTextAlign="Center" />
                                    </ColumnsDirective>
                                    <Inject services={[Page, Sort, Filter, Group]} />
                                </GridComponent>
                            </div>
            ...
            {modalHandleJenisTransaksi && (
                <DialogComponent
                    ...
                    visible={modalHandleJenisTransaksi}
                    isModal={true}
                ...
                >
                    <div style={{ marginLeft: 30, marginBottom: 10 }}>
                        <ButtonComponent cssClass="e-secondary e-small" style={{ width: '85%' }} onClick={() => handleNavigateJenisTransaksi('persediaan', 'create')}>
                            Barang Persediaan
                        </ButtonComponent>
                    </div>
                    <br></br>
                    <div style={{ marginLeft: 30, marginBottom: 10 }}>
                        <ButtonComponent cssClass="e-secondary e-small" style={{ width: '85%' }} onClick={() => handleNavigateJenisTransaksi('nonPersediaan', 'create')}>
