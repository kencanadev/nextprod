...
const TemplateDetailRpe: React.FC<templateDetailRpeProps> = ({
    ...
    return (
        <div className="panel-tab" style={{ background: '#F7F7F7', width: '100%', height: '245px' }}>
                ...
                <div className="e-content">
                    <div style={{ width: '100%', height: '100%', marginTop: '5px' }} tabIndex={0}>
                        ...
                        <GridComponent
                            ...
                            autoFit={true}
                            rowHeight={22}
                            height={133} //170 barang jadi 150 barang produksi
                            gridLines={'Both'}
                    ...
                    <div style={{ width: '100%', height: '100%', marginTop: '5px' }} tabIndex={1}>
                        <div className="flex">
                            <div style={{ width: '28%' }}>
                                ...
                                <div className="border p-3" style={{ backgroundColor: 'white', borderRadius: 6, fontSize: 11, height: '172px', marginLeft: '10px', overflowY: 'scroll' }}>
