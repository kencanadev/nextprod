...
const ReportPage = () => {
    ...
    const [kodeRpe, setKodeRpe] = useState('');
    ...
    useEffect(() => {
        ...
        const param1 = params.get('kode_rpe');
    ...
    useEffect(() => {
        dispatch(setPageTitle('Form Realisasi Pembayaran Ekspedisi'));
    });
    ...
    return (
        <div style={{ width: '100%', height: '100vh' }}>
            <Viewer reportUri="/report/transaksi//inventory/rpe/rpRpe.rdlx-json" reportParam={parameter} />
        </div>
    );
};
