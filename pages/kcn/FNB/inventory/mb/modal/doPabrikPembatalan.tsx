...
import { formatNumber, frmNumber, generateNU, FillFromSQL, FirstDayInPeriod, tanpaKoma, fetchPreferensi, overQTYAll } from '@/utils/routines';
...
const DOPabrikPembatalan: React.FC<dialogMutasiBarangAntarGudang> = ({ userid, kode_entitas, isOpen, onClose, kode_user, status_edit, kode_mb_edit, jenisDO, onRefresh }) => {
                                        ...
                                        <div style={{ padding: 5 }} className="panel-pager">
                                            ...
                                            <div>
                                                ...
                                                <div className="panel-input" style={{ width: '100%', minHeight: 60, marginTop: 5 }}>
                                                    <textarea value={keterangan} className='w-full h-full text-xs' rows={2} onChange={(e: any) => setKeterangan(e.target.value)} />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
export default DOPabrikPembatalan;
