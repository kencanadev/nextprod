...
const MutasiBarangAntarGudang: React.FC<dialogMutasiBarangAntarGudang> = ({ userid, kode_entitas, isOpen, onClose, kode_user, status_edit, kode_mb_edit, onRefresh }) => {
                    ...
                    header: [
                        {
                            ...
                            user_pengajuan: null,
                            user_approval: null,
                            jenis_mb: 'MB', // kirim gudang //MB untuk MB
                            pengemudi: '',
                            do_kode_sj: '',
                ...
                if (status_edit == true) {
                    ...
                    for (const element of modifiedDetailJson) {
                        const result = await overQTYAllCustom(
                            ...
                            selectedGudang.kode_gudang,
                            element.kode_item,
                            moment(tglMB).format('YYYY-MM-DD HH:mm:ss'),
                            kodeMB,
                            element.qty,
                            'mb',
                            `Item : ${element.no_barang} - ${element.nama_barang} \n`,
                            '#dialogMBList'
                        );
    ...
    return (
        <DialogComponent
            ...
            header={status_edit === false ? 'Mutasi Barang Antar Gudang' : 'Mutasi Barang Antar Gudang (EDIT)'}
            showCloseIcon={true}
            target="#main-target"
            closeOnEscape={false}
            allowDragging={true}
                                        ...
                                        <td style={{ textAlign: 'center', border: '1px solid grey' }}>
                                            ...
                                            <div className="flex">
                                                <DropDownListComponent
                                                    ...
                                                    select={(e) => {
                                                        // console.log('itemData', e.itemData.via);
                                                        setSelectedVia(e.itemData.via);
                                                    }}
...
export default MutasiBarangAntarGudang;
