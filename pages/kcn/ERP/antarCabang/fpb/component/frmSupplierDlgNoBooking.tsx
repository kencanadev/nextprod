...
interface FrmSupplierDlgNoBookingProps {
    isOpen: boolean;
    onClose: any;
    onBatal: any;
    selectedData: any;
...
const FrmSupplierDlgNoBooking = ({ isOpen, onClose, onBatal, selectedData, target, stateDokumen }: FrmSupplierDlgNoBookingProps) => {
    ...
    const fetchDataDialog = async () => {
        try {
            const response = await axios.get(`${apiUrl}/erp/get_po_supplier?entitas=${stateDokumen.kode_entitas}`, {
                headers: {
...
export default FrmSupplierDlgNoBooking;
