                ...
                const newNodes = state.nodes.map((node: any) => {
                    if (node.id_pp === id_pp) {
                        if (property === 'qty') {
                            ...
                            const display_fpp_btg = document.getElementById('id_fpp_btg' + node.id_pp) as HTMLInputElement;
                            if (display_fpp_btg) {
                                display_fpp_btg.value = frmNumber(value !== '' ? String(Math.ceil(SpreadNumber(newFrmNumber(String(value)) / newFrmNumber(fpp_kg)))) : '0');
                            }
                            const display_fpp_harga_btg = document.getElementById('id_fpp_harga_btg' + node.id_pp) as HTMLInputElement;
                            if (display_fpp_harga_btg) {
                                display_fpp_harga_btg.value = frmNumber(value !== '' ? String(newFrmNumber(fpp_kg) * newFrmNumber(fpp_harga_kg)) : '0');
                            ...
                            return {
                                ...
                                fpp_btg: value !== '' ? String(Math.ceil(SpreadNumber(newFrmNumber(String(value)) / newFrmNumber(fpp_kg)))) : '0',
                            ...
                            const display_fpp_btg = document.getElementById('id_fpp_btg' + node.id_pp) as HTMLInputElement;
                            if (display_fpp_btg) {
                                const temp = frmNumber(value !== '' ? String(Math.ceil(SpreadNumber(newFrmNumber(fpp_qty) / newFrmNumber(value)))) : '0');
                            ...
                            return {
                                ...
                                [property]: value,
                                //  fpp_btg: value !== '' ? String(SpreadNumber(parseFloat(tanpaKoma(value)) / fpp_kg)) : '0',
                                fpp_btg: value !== '' ? String(Math.ceil(SpreadNumber(newFrmNumber(fpp_qty) / newFrmNumber(value)))) : '0',
                            ...
                            const display_fpp_btg = document.getElementById('id_fpp_btg' + node.id_pp) as HTMLInputElement;
                            if (display_fpp_btg) {
                                display_fpp_btg.value = frmNumber(value !== '' ? String(Math.ceil(SpreadNumber(newFrmNumber(fpp_qty) / newFrmNumber(fpp_kg)))) : '0');
                            }
                            const display_fpp_harga_btg = document.getElementById('id_fpp_harga_btg' + node.id_pp) as HTMLInputElement;
                            if (display_fpp_harga_btg) {
                                display_fpp_harga_btg.value = frmNumber(value !== '' ? String(newFrmNumber(fpp_kg) * newFrmNumber(value)) : '0');
                            ...
                            return {
                                ...node,
                                [property]: value,
                                fpp_btg: value !== '' ? String(Math.ceil(SpreadNumber(newFrmNumber(fpp_qty) / newFrmNumber(fpp_kg)))) : '0',
                            ...
                            const display_fpp_btg = document.getElementById('id_fpp_btg' + node.id_pp) as HTMLInputElement;
                            if (display_fpp_btg) {
                                const temp = frmNumber(value !== '' ? String(Math.ceil(SpreadNumber(newFrmNumber(fpp_qty) / SpreadNumber(newFrmNumber(value) * newFrmNumber(value) * 0.006165 * panjang)))) : '0');
                                display_fpp_btg.value = temp;
                                console.log(`rumus btg ${newFrmNumber(fpp_qty)} / (${newFrmNumber(value)}  * ${newFrmNumber(value)} * ${0.006165} * ${newFrmNumber(panjang)}) = ${temp}`);
                            }
                            ...
                            return {
                                ...
                                fpp_btg: value !== '' ? String(Math.ceil(SpreadNumber(newFrmNumber(fpp_qty) / SpreadNumber(newFrmNumber(value) * newFrmNumber(value) * 0.006165 * panjang)))) : '0',
                                tgl_butuh: moment(date1).format('YYYY-MM-DD HH:mm:ss'),
                            };
                        } else if (property === 'fpp_jarak') {
                            const display_fpp_jarak = document.getElementById('id_fpp_jarak' + node.id_pp) as HTMLInputElement;
