...
const PilihBaru: React.FC<PilihBaruProps> = ({ isOpen = false, onClose, date1, date2, tipeDokumen, onSelectData, tipeForm = '' }) => {
    ...
    if (tipeForm === 'dashboard') {
      router.push({ pathname: '/kcn/ERP/purchase/pp/spp', query: { kode_pp: 'BARU', name: 'produksi', tglAwal: `${date1}`, tglAkhir: `${date2}`, vTipeDokumen: `${tipeDokumen}`, tipe: 'dashboard' } });
    } else {
  ...
  const handleBuBarangJadiClick = (tipe: any) => {
    if (tipeForm === 'dashboard') {
      router.push({ pathname: '/kcn/ERP/purchase/pp/spp', query: { kode_pp: 'BARU', name: tipe, tglAwal: `${date1}`, tglAkhir: `${date2}`, vTipeDokumen: `${tipeDokumen}`, tipe: 'dashboard' } });
    } else {
