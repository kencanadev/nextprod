...
export const ReCalcDataNodesEdit = async (dataDetail: any) => {
    ...
    const newNodes = dataDetail.nodes.map((node: any) => {
        ...
        return {
            ...node,
            qty: newFrmNumber(node.qty),
            qty_std: newFrmNumber(node.qty_std),
            qty_sisa: newFrmNumber(node.qty_sisa),
            fpp_qty: newFrmNumber(node.fpp_qty),
            fpp_diameter: newFrmNumber(node.fpp_diameter),
            fpp_kg: newFrmNumber(node.fpp_kg),
            fpp_btg: newFrmNumber(node.fpp_btg),
            fpp_harga_kg: newFrmNumber(node.fpp_harga_kg),
            fpp_harga_btg: newFrmNumber(node.fpp_harga_btg),
            fpp_jarak: newFrmNumber(node.fpp_jarak),
            berat: newFrmNumber(node.berat),
