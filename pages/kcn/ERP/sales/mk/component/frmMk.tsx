                ...
                if (quMMKtipe === 'Cabang') {
                    ...
                    if (quMMKnetto_mu > 0) {
                        ...
                        if (IsTunai) {
                            ...
                            quJurnaltipe = result[0].tipe_kas.toLowerCase();
                            ...
                            quJurnaltipe = result[0].tipe_piutang.toLowerCase();
                    ...
                    const vCekAkunPajak = cekAkunPajak.data.data.length > 0 ? cekAkunPajak.data.data[0]?.kode_akun : null;
