...
function KlaimBarangKurangKons() {
    ...
    const [isLoadingMod, setIsLoadingMod] = useState<any>(0);
    ...
    const refreshData = async () => {
        ...
        setErrorMassage('');
        setCurrentIndicator(`Persiapan Mengambil Data`);
        setIsLoadingMod(5);
        ...
        try {
            ...
            setCurrentIndicator(`Memulai Mengambil Data`);
            setIsLoadingMod(10);
            ...
            setCurrentIndicator(`Mengambil Data Ke Server...`);
            setIsLoadingMod(15);

            let progress = 40;
            const interval = setInterval(() => {
                progress += 1;
                setIsLoadingMod(progress);
            ...
            // Setelah selesai request
            clearInterval(interval); // pastikan berhenti kalau axios selesai lebih dulu
            ...
            setIsLoadingMod(100);
            setCurrentIndicator(`Data Terambil`);
    ...
    return (
        <ExampleProvider>
            <div className="flex h-[620px] w-full flex-col " id="main-target">
                ...
                <DialogComponent width="500px" height="200px" isModal={true} target="#main-target" visible={showLoadingModal} close={() => setShowLoadingModal(false)} overlayClick={() => {}}>
                    <div className="flex h-full w-full items-center justify-center">
                        <div className="w-full flex-grow px-10">
                            <p>Proses : {currentIndicator}</p>
                            <LinearProgress variant="buffer" value={isLoadingMod} color={errorMassage === '' ? 'primary' : 'error'} valueBuffer={isLoadingMod} />
