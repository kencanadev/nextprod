    ...
    return (
        <div className="mt-1 h-full">
            ...
            <div className="flex w-full flex-grow">
                {activeMainTab === 'dikirim_gudang' && (
                    <KirimGudang data={gudangData} refGrid={refGridGudang} refreshData={refreshData} handleRowSelected={handleRowSelected} selectedItems={selectedItems} />
                )}
