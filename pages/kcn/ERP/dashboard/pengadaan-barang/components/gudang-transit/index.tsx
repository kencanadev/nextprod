...
const InfoGudangTransit = ({ kode_entitas, token }: InfoGudangTransitProps) => {
    ...
    const fetchData = async () => {
        ...
        const modifiedData = res
            ...
            .sort((a: any, b: any) => b.umur_stok - a.umur_stok);
        setData(modifiedData);
        gridTransitRef.current?.setProperties({ dataSource: modifiedData });
    ...
    return (
        <div className="Main h-[calc(130vh-240px)] w-[calc(130vw)]" id="gudang-transit">
            <div className="relative flex h-full">
                ...
                <div className="h-full w-full flex-1 overflow-auto bg-white">
                    ...
                    >
                        <ColumnsDirective>
                            <ColumnDirective field="nama_item" headerText="Nama Barang" width="270" headerTextAlign="Center" textAlign="Left" clipMode="EllipsisWithTooltip" />
                            <ColumnDirective
                                field="stok_minimal"
