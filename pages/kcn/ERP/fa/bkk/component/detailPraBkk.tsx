...
import { resPdf } from '../../bm/component/resource';
                        ...
                        <div tabIndex={0} style={{ width: '100%', height: '100%', marginTop: '5px', padding: 5 }}>
                            <TooltipComponent openDelay={1000} target=".e-headertext">
                                <GridComponent
                                    ...
                                    autoFit={true}
                                    rowHeight={22}
                                    height={215} //170 barang jadi 150 barang produksi
                                    gridLines={'Both'}
                                    ...
                                    <div tabIndex={0} style={{ width: '100%', height: '100%', marginTop: '5px', padding: 10 }}>
                                        <div style={{ display: 'flex' }}>
                                            ...
                                            {objekImage?.preview && (
                                                <div style={{ marginTop: 0, marginLeft: 20, border: '3px solid #dedede', borderRadius: 5 }} className="preview">
                                                    <Image
                                                        src={objekImage?.preview.startsWith('data:application/pdf') ? resPdf : objekImage?.preview}
                                                        alt="Large Image"
                                                        width={300}
                                                        height={300}
                                    ...
                                    <div tabIndex={1} style={{ width: '100%', height: '100%', marginTop: '5px', padding: 10 }}>
                                        <div style={{ display: 'flex' }}>
                                            ...
                                            {objekImage?.preview2 && (
                                                <div style={{ marginTop: 0, marginLeft: 20, border: '3px solid #dedede', borderRadius: 5 }} className="preview">
                                                    <Image
                                                        src={objekImage?.preview2.startsWith('data:application/pdf') ? resPdf : objekImage?.preview2}
                                                        alt="Large Image"
                                                        width={300}
                                                        height={300}
                                                        style={{ width: '100%', height: '300px' }}
                                    ...
                                    <div tabIndex={2} style={{ width: '100%', height: '100%', marginTop: '5px', padding: 10 }}>
                                        <div style={{ display: 'flex' }}>
                                            ...
                                            {objekImage?.preview3 && (
                                                <div style={{ marginTop: 0, marginLeft: 20, border: '3px solid #dedede', borderRadius: 5 }} className="preview">
                                                    <Image
                                                        src={objekImage?.preview3.startsWith('data:application/pdf') ? resPdf : objekImage?.preview3}
                                                        alt="Large Image"
                                                        width={300}
                                                        height={300}
                                                        style={{ width: '100%', height: '300px' }}
                                    ...
                                    <div tabIndex={4} style={{ width: '100%', height: '100%', marginTop: '5px', padding: 10 }}>
                                        <div style={{ display: 'flex' }}>
                                            ...
                                            {objekImage?.preview4 && (
                                                <div style={{ marginTop: 0, marginLeft: 20, border: '3px solid #dedede', borderRadius: 5 }} className="preview">
                                                    <Image
                                                        src={objekImage?.preview4.startsWith('data:application/pdf') ? resPdf : objekImage?.preview4}
                                                        alt="Large Image"
                                                        width={300}
                                                        height={300}
                                                        style={{ width: '100%', height: '300px' }}
