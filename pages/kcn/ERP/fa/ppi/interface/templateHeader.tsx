                            ...
                            {modalJenisPenerimaan === 'Warkat' || modalJenisPenerimaan === 'Penolakan' || modalJenisPenerimaan === 'Edit Penolakan' || modalJenisPenerimaan === 'batal tolak' ? (
                                ...
                                <>
                                    ...
                                    <input
                                        ...
                                        placeholder="<No Akun>"
                                        disabled={masterDataState === 'UpdateFilePendukung' || dataHeaderAPI?.tipeApi === 'API' ? true : false}
                                    ></input>
                                    <input
                                        className={` container form-input`}
                                        onChange={(event) => {
                                    ...
                                    >
                                        {masterDataState === 'UpdateFilePendukung' || dataHeaderAPI?.tipeApi === 'API' || dataHeaderAPI?.tipeApi === 'APIWarkat' ? null : (
                                            <button
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', width: '30%' }}>
                        ...
                        <div className="flex">
                                    ...
                                    {masterDataState == 'UpdateFilePendukung' ? (
                                        ...
                                        <div className="container form-input" style={{ borderRadius: 2, width: '100%', marginLeft: 0, marginTop: 4 }}>
                                            <TextBoxComponent
                                                ...
                                                disabled={masterDataState === 'UpdateFilePendukung'}
                                            />
                                        </div>
                                    )}
                                    {masterDataState === 'UpdateFilePendukung' ? (
                                        ...
                                        <input
                                            ...
                                            disabled={true}
                                            value={moment(stateDataHeader?.tglReferensi).format('DD-MM-YYYY')}
                                            readOnly
                                        ></input>
                                    ) : (
                            ...
                            {modalJenisPenerimaan === 'Warkat' ? (
                              ...
                              modalJenisPenerimaan === 'Edit Pencairan' ||
                              modalJenisPenerimaan === 'Edit Penolakan' ||
                              (masterDataState == 'UpdateFilePendukung' && modalJenisPenerimaan === 'Cair') ? (
                                <>
                                    <div style={{ width: '62%' }}>
                                        <div className="border p-3" style={{ backgroundColor: '#eeeeee', borderRadius: 1, height: 136 }}>
                                            <div className="flex">
                                                ...
                                                <div style={{ width: '55%', marginTop: '-13px' }}>
                                                    {dataHeaderAPI?.tipeApi === 'APIWarkat' || masterDataState == 'UpdateFilePendukung' ? (
                                                        <input
                                                            className={` container form-input`}
                                                            style={{
                                                                background: '#eeeeee',
                                                ...
                                                <div style={{ width: '55%' }}>
                                                    {dataHeaderAPI?.tipeApi === 'APIWarkat' || masterDataState == 'UpdateFilePendukung' ? (
                                                        <input
                                                            ...
                                                            value={
                                                                masterDataState == 'UpdateFilePendukung'
                                                                    ? moment(stateDataHeader?.tglEfektif).format('DD-MM-YYYY')
                                                                    : moment(dataHeaderAPI?.tglTransaksiMutasi).format('DD-MM-YYYY')
                                                            }
                                                            readOnly
                                                        ></input>
                                                    ) : (
