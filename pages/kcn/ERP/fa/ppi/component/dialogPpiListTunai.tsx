...
import { appBackdate, cekNoDokTerakhir } from '@/utils/global/fungsi';
...
interface dialogPpiListTunaiProps {
    userid: any;
    kode_entitas: any;
...
const DialogPpiListTunai: React.FC<dialogPpiListTunaiProps> = ({
    userid,
    kode_entitas,
    masterKodeDokumen,
    masterDataState,
...
dialogPpiListTunaiProps) => {
                ...
                if (masterDataState == 'BARU') {
                    ...
                    await resultListEditPPIMaster.map((item: any) => {
                        setStateDataHeader((prevState: any) => ({
                            ...
                            kodeAkunUangMukaJual: quSetting[0].kode_akun_uangmukajual,
    ...
    const onClickTemplateAkun = async (args: any) => {
        ...
        //     rowsIdJurnal: tipe_Add.current === 'add' ? dokumenId.current : args.id,
        // }));
    };
...
// ambil semua yang bayar_mu > 0
        ...
        // const resultTglMinus14 = await CekTglMinus14(stateDataHeader?.tglDokumen);
        ...
        //     .then(async (result) => {
        //         console.log('result 121313 = ', result, resultCekUserApp[0].app_backdate, resultTglMinus14, resultTglPlus3, resultTglPlus14);
        ...
        //                     });
        //                     return;
        //                 } else if (resultTglMinus14 === false) {
        //                     withReactContent(swalToast).fire({
        //                         icon: 'warning',
        //                         title: '<p style="font-size:12px;color:white;">Tanggal lebih kecil 14 hari dari hari ini.</p>',
        //                         width: '100%',
        //                         target: '#dialogPhuList',
        //                         customClass: {
        //                             popup: styles['colored-popup'], // Custom class untuk sweetalert
        ...
        if (dataJurnal.nodes.length > 0) {
            ...
            // if (parseFloat(totalDebet.toFixed(2)) !== TotAlokasiDana && parseFloat(totalKredit.toFixed(2)) !== TotAlokasiDana && parseFloat(stateDataHeader?.jumlahBayar) !== TotAlokasiDana) {
            //     withReactContent(swalToast).fire({
            //         icon: 'warning',
            //         title: '<p style="font-size:12px;color:white">Nilai jurnal berbeda dengan nilai dokumen, periksa kembali</p>',
            //         width: '100%',
            ...
            if (masterDataState === 'BARU') {
                ...
                if (status === true) {
                    ...
                    const auditResponse = await axios.post(`${apiUrl}/erp/simpan_audit`, {
                        ...
                        proses: 'NEW',
                        diskripsi: `Penerimaan Piutang tunai nilai transaksi = ${frmNumber(stateDataHeader?.jumlahBayar)}`,
                ...
                // await handleUploadZip('PU0000001121');
...
export default DialogPpiListTunai;
