...
dialogPenolakanWarkatProps) => {
        ...
        if (kode_entitas !== null || kode_entitas !== '') {
            try {
                ...
                if (masterDataState == 'BARU') {
                    ...
                    if (modalJenisPenerimaan === 'Edit Penolakan') {
    ...
    const saveDoc = async () => {
        ...
        const paramObject = {
            ...
            tglDokumen: stateDataHeader?.tglEfektif.format('YYYY-MM-DD HH:mm:ss'),
            ...
            await ReCalcDataNodes(dataBarang, dataJurnal, paramObject)
                .then((result) => {
                    jsonData = {
                        ...
                        tgl_approved: null,
                        tgl_pengakuan: stateDataHeader?.tglEfektif.format('YYYY-MM-DD HH:mm:ss'),
            ...
            if (masterDataState === 'Penolakan') {
                ...
                if (status === true) {
                    const auditResponse = await axios.post(`${apiUrl}/erp/simpan_audit`, {
                        ...
                        proses: 'EDIT',
                        diskripsi: `Penolakan BG nilai transaksi = ${frmNumber(stateDataHeader?.jumlahBayar)}`,
        ...
        <div>
            <DialogComponent
                ...
                header={() => {
                    ...
                    } else if (masterDataState == 'Penolakan') {
                        header = (
                            <div>
                                <div className="header-title">
            ...
            >
                ...
                >
                    {(masterDataState == 'BARU' || masterDataState == 'Penolakan') && (
                        <ButtonComponent
                            id="buBatalDokumen1"
                            content="Batal"
                    ...
                    {(masterDataState == 'BARU' || modalJenisPenerimaan == 'Penolakan') && (
                        <ButtonComponent
                            id="buSimpanDokumen1"
                            content="Simpan"
                            cssClass="e-primary e-small"
