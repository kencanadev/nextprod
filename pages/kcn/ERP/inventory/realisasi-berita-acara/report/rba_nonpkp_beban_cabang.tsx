...
const ReportPage = () => {
    ...
    useEffect(() => {
        dispatch(setPageTitle('Laporan Klaim Barang NON PKP'));
    });
    ...
    return (
        <div style={{ width: '100%', height: '100vh' }}>
            <Viewer reportUri="/report/transaksi//inventory/rba/rba_nonpkp_beban_cabang.rdlx-json" reportParam={parameter} />
        </div>
    );
};
