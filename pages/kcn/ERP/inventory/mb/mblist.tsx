...
import MutasiBarangNonPersediaan from './modal/mutasiBarangNonPersediaan';
import DOPabrikPembatalanMKL from './modal/doPabrikPembatalanMKL';
...
const MutasiBarangList = () => {
    ...
    const [modalMutasiNonPersediaan, setModalMutasiNonPersediaan] = useState(false);
    ...
    const [modalDOPabrikPembatalanMKL, setModalDOPabrikPembatalanMKL] = useState<any>(false);
    ...
    const rowDataBoundListData = (args: any) => {
        ...
        if (rowData.nama_gudang_cabang === 'BATAL DO PABRIK') {
        ...
        //     }
        //     if (args.data.status === 'Tertutup') {
        //          args.row.classList.add('text-red-400');
        //     }
        // }
    };
    ...
    //     if(args.column?.field === 'approval') {
    //         if (getValue('approval', args.data) == 'N') {
    //             args.cell.style.color = 'red';
    //         }
    //     }
    // };
    ...
    const handleInputNoMB = (value: any) => {
        setnoMBValue(value);
        setisNoMBChecked(value.length > 0);
    };
    ...
    const handleRefreshData = async () => {
        ...
        if (kode_entitas !== null || kode_entitas !== '') {
            try {
                ...
                if (selectedRadioJenisMB === 'KL') {
                    vJenisMB = 'KL';
                } else if (selectedRadioJenisMB === 'KG') {
                    vJenisMB = 'KG';
                } else if (selectedRadioJenisMB === 'MKL') {
                    vJenisMB = 'MKL';
                } else if (selectedRadioJenisMB === 'MKG') {
                    vJenisMB = 'MKG';
                } else if (selectedRadioJenisMB === 'MB') {
                    vJenisMB = 'MB';
                } else if (selectedRadioJenisMB === 'MBNP') {
                    vJenisMB = 'MBNP';
    ...
    const handleGudangChangeAsal = (value: any) => {
        setSelectedOptionGudang(value);
        setIsGudangChecked(value.length > 0);
    };

    const handleGudangChangeTujuan = (value: any) => {
        setSelectedOptionGudangTujuan(value);
        setIsGudangCheckedTujuan(value.length > 0);
    };

    const handleNoKendaraanInputChange = (value: any) => {
        setnopolValue(value);
        setisNopolChecked(value.length > 0);
    };

    const handleViaSelectChange = (value: any) => {
        setviaValue(value);
        setisViaChecked(value.length > 0);
    };
    ...
    const handleRadioJenisMB = (event: any) => {
        console.log(event.target.id);
        setselectedRadioJenisMB(event.target.id);
    };
    ...
    const handleNavigateLink = async (jenis: any) => {
        ...
        if (jenis === '1') {
            ...
            setStatusEdit(false);
            setModalMutasiNonPersediaan(true);
            console.log('Barang non persediaan');
        }
        ...
        if (jenis === 'edit') {
            ...
            if (selectedRow) {
                if (selectedRow.tgl_mb < formatPeriode) {
                    ...
                    } else if (selectedRow.jenis_mb === 'MBNP') {
                        setStatusEdit(true);
                        setModalMutasiNonPersediaan(true);
                    }
                }
    ...
    const batalDoPabrik = (data: any) => {
        if (data.kontrak === 'Y') {
            if (data.status === 'Terbuka') {
                ...
                } else if (data.jenis_mb === 'MKL') {
                    setStatusEdit(true);
                    setModalDOPabrikPembatalanMKL(true);
                } else {
    ...
    return (
        <div className="main" id="main-target">
                                ...
                                <div id="inputFilter">
                                    ...
                                    <div className="mt-1 flex justify-between">
                                        <div className="container form-input">
                                            <TextBoxComponent placeholder="" value={noMBValue} input={(args) => handleInputNoMB(args.value)} />
                                        </div>
                                    </div>
                                    ...
                                    <div className="mt-2 flex justify-between">
                                        <CheckBoxComponent
                                            label="Gudang Tujuan"
                                            checked={isGudangCheckedTujuan}
                                            change={(args: ChangeEventArgsButton) => {
                                                const value: any = args.checked;
                                                setIsGudangCheckedTujuan(value);
                                            }}
                                        />
                                    </div>
                                    <div className="mt-1 flex justify-between">
                                        <div className="container form-input">
                                            <DropDownListComponent
                                                ...
                                                change={(args: ChangeEventArgsDropDown) => {
                                                    const value: any = args.value;
                                                    console.log(value);
                                                    handleGudangChangeTujuan(value);
                                                }}
                                                value={selectedOptionGudangTujuan}
                                            />
                                        </div>
                                    </div>
                                    ...
                                    <div className="mt-2 flex justify-between">
                                        <CheckBoxComponent
                                            label="No. Kendaraan"
                                            checked={isNopolChecked}
                                            change={(args: ChangeEventArgsButton) => {
                                                const value: any = args.checked;
                                                setisNopolChecked(value);
                                            }}
                                        />
                                    </div>
                                    <div className="mt-1 flex justify-between">
                                        <div className="container form-input">
                                            <DropDownListComponent
                                                id="nokendaraan"
                                                className="form-select"
                                                dataSource={apiResponseNopol.map((data: any) => data.nopol)}
                                                placeholder="--Silahkan Pilih--"
                                                change={(args: ChangeEventArgsDropDown) => {
                                                    const value: any = args.value;
                                                    console.log(value);
                                                    handleNoKendaraanInputChange(value);
                                                }}
                                                value={nopolValue}
                                            />
                                        </div>
                                    ...
                                    <div className="mt-1 flex justify-between">
                                        <div className="container form-input">
                                            <DropDownListComponent
                                                id="viaekspedisi"
                                                className="form-select"
                                                dataSource={apiResponseVia.map((data: any) => data.via)}
                                                placeholder="--Silahkan Pilih--"
                                                change={(args: ChangeEventArgsDropDown) => {
                                                    const value: any = args.value;
                                                    console.log(value);
                                                    handleViaSelectChange(value);
                                                }}
                                                value={viaValue}
                                            />
                                        </div>
                                    ...
                                    <div className="mt-1">
                                        <div>
                                            <h3 style={{ fontWeight: 'bold' }}>DO Pabrik</h3>
                                        </div>
                                        <div>
                                            <div>
                                                <RadioButtonComponent id="ya" label="Ya" name="doPabrik" cssClass="e-small" checked={selectedRadioDOPabrik === 'ya'} onChange={handleDOPabrik} />
                                                <RadioButtonComponent
                                                    id="tidak"
                                                    label="Tidak"
                                                    name="doPabrik"
                                                    cssClass="e-small"
                                                    checked={selectedRadioDOPabrik === 'tidak'}
                                                    onChange={handleDOPabrik}
                                                />
                                                <RadioButtonComponent
                                                    id="semua"
                                                    label="Semua"
                                                    name="doPabrik"
                                                    cssClass="e-small"
                                                    checked={selectedRadioDOPabrik === 'semua'}
                                                    onChange={handleDOPabrik}
                                                />
                                            </div>
                                        </div>
                                    ...
                                    <div className="mt-1">
                                        <div>
                                            <h3 style={{ fontWeight: 'bold' }}>Jenis MB</h3>
                                        </div>
                                        <div>
                                            <div className="mt-1">
                                                <div className="flex">
                                                    <RadioButtonComponent
                                                        id="KL"
                                                        label="Ekspedisi Kirim Langsung"
                                                        name="jenisMB"
                                                        cssClass="e-small"
                                                        checked={selectedRadioJenisMB === 'KL'}
                                                ...
                                                <div className="mt-1.5 flex">
                                                    <RadioButtonComponent
                                                        id="KG"
                                                        label="Ekspedisi Kirim Gudang"
                                                        name="jenisMB"
                                                        cssClass="e-small"
                                                        checked={selectedRadioJenisMB === 'KG'}
                                                        onChange={handleRadioJenisMB}
                                                    />
                                                </div>
                                                <div className="mt-1.5 flex">
                                                    <RadioButtonComponent
                                                        id="MKL"
                                                        label="Mobil Sendiri Kirim Langsung"
                                                        name="jenisMB"
                                                        cssClass="e-small"
                                                        checked={selectedRadioJenisMB === 'MKL'}
                                                        onChange={handleRadioJenisMB}
                                                    />
                                                </div>
                                                <div className="mt-1.5 flex">
                                                    <RadioButtonComponent
                                                        id="MKG"
                                                        label="Mobil Sendiri Kirim Gudang"
                                                        name="jenisMB"
                                                        cssClass="e-small"
                                                        checked={selectedRadioJenisMB === 'MKG'}
                                                        onChange={handleRadioJenisMB}
                                                    />
                                                </div>
                                                <div className="mt-1.5 flex">
                                                    <RadioButtonComponent
                                                        ...
                                                        name="jenisMB"
                                                        cssClass="e-small"
                                                        checked={selectedRadioJenisMB === 'MB'}
                                                        onChange={handleRadioJenisMB}
                                                    />
                                                </div>
                                                <div className="mt-1.5 flex">
                                                    <RadioButtonComponent
                                                        id="MBNP"
                                                        label="Mutasi Barang Non Persediaan"
                                                        name="jenisMB"
                                                        cssClass="e-small"
                                                        checked={selectedRadioJenisMB === 'MBNP'}
                                                        onChange={handleRadioJenisMB}
                                                    />
                                                </div>
                                                <div className="mt-1.5 flex">
                                    ...
                                    <div className="mt-3 flex justify-between">
                                        <CheckBoxComponent
                                            label="Pembatalan DO Pabrik"
                                            checked={isBatalDOChecked}
                                            change={(args: ChangeEventArgsButton) => {
                                                const value: any = args.checked;
                                                setisBatalDOChecked(value);
                                            }}
                                            style={{ color: 'red' }}
                                        />
                                    </div>
                            ...
                            <div className="e-content">
                                <div>
                                    <GridComponent
                                        ...
                                        queryCellInfo={(args) => {
                                            if (args.data.status.toLowerCase() === 'tertutup') {
                                                args.cell.style.color = '#DB1E1F'; //merah
                                            }
                                        }}
                                    ...
                                    >
                                        ...
                                        <AggregatesDirective>
                                            <AggregateDirective>
                                                <AggregateColumnsDirective>
                                                    <AggregateColumnDirective field="total_berat" type="Sum" format="N2" footerTemplate="${Sum}" />
                                                </AggregateColumnsDirective>
                                            </AggregateDirective>
                                        </AggregatesDirective>
                ...
                >
                    ...
                    <div style={{ padding: 10 }} className="flex items-center">
                        <RadioButtonComponent
                            ...
                            change={() => changeModalJenisTransaksi('5')}
                            // ref={(radio1) => (radioInstanceTunai = radio1 as RadioButtonComponent)}
                            cssClass="e-small"
                        />
                    </div>
            ...
            {modalMutasiNonPersediaan && (
                <MutasiBarangNonPersediaan
                    userid={userid}
                    kode_entitas={kode_entitas}
                    isOpen={modalMutasiNonPersediaan}
                    onClose={() => {
                        setModalMutasiNonPersediaan(false);
                        setStatusEdit(false);
                    }}
                    kode_user={kode_user}
                    status_edit={statusEdit}
            ...
            {modalDOPabrikPembatalanMKL && (
                <DOPabrikPembatalanMKL
                    userid={userid}
                    kode_entitas={kode_entitas}
                    isOpen={modalDOPabrikPembatalanMKL}
                    onClose={() => {
                        setModalDOPabrikPembatalanMKL(false);
                    }}
                    kode_user={kode_user}
                    status_edit={statusEdit}
                    kode_mb_edit={selectedRow !== '' ? selectedRow.kode_mb : ''}
