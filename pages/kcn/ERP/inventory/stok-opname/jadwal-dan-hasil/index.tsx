...
import { handleJenisCheckbox, handleJenisTransaksiCheckbox, handleStatusCheckbox, showErrorPopup } from './functions';
        ...
        if (args.column.field === 'alasan_koreksi') {
            ...
            if (applevel === '0' || applevel === '8' || applevel === '9') {
                ...
                if (komplit === 'Y') {
                    ...
                    await showErrorPopup('Data opname sudah komplit.', 350, '');
                } else {
                    // alert(`Data opname sudah diapproval level #${applevel}`);
                    await showErrorPopup(`Data opname sudah diapproval level #${applevel}.`, 350, '');
                }
            }
