...
const ReportPage = () => {
    ...
    useEffect(() => {
        dispatch(setPageTitle('Cash Flow'));
    });
    ...
    return (
        <div style={{ width: '100%', height: '100vh' }}>
            <Viewer reportUri="/report/transaksi/laporan/laporan_keuangan//cash_flow.rdlx-json" reportParam={parameters} hiddenPrint={allowPrint} />
