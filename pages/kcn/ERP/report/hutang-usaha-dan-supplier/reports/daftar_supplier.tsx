...
const ReportPage = () => {
    ...
    useEffect(() => {
        dispatch(setPageTitle('Laporan Daftar Supplier'));
    });
    ...
    return (
        <div style={{ width: '100%', height: '100vh' }}>
            <Viewer reportUri="/report/laporan//hutang-usaha-dan-supplier/daftar_supplier.rdlx-json" reportParam={parameter} hiddenPrint={allowPrint} />
        </div>
    );
};
