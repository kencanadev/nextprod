...
const ReportPage = () => {
    ...
    useEffect(() => {
        dispatch(setPageTitle('Aging Hutang Supplier + Warkat'));
    });
    ...
    return (
        <div style={{ width: '100%', height: '100vh' }}>
            <Viewer reportUri="/report/laporan//hutang-usaha-dan-supplier/rekapitulasi_hutang_supplierWarkat_byUmur.rdlx-json" reportParam={parameter} hiddenPrint={allowPrint} />
        </div>
    );
};
