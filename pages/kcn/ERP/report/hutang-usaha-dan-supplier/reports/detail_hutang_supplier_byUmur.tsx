...
const ReportPage = () => {
    ...
    useEffect(() => {
        dispatch(setPageTitle('Detail Aging Hutang Supplier'));
    });
    ...
    return (
        <div style={{ width: '100%', height: '100vh' }}>
            <Viewer reportUri="/report/laporan//hutang-usaha-dan-supplier/detail_hutang_supplier_byUmur.rdlx-json" reportParam={parameter} hiddenPrint={allowPrint} />
        </div>
    );
};
