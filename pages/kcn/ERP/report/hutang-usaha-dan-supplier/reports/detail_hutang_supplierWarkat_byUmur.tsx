...
const ReportPage = () => {
    ...
    useEffect(() => {
        ...
        const param2 = params.get('kodeSupp');
    ...
    useEffect(() => {
        dispatch(setPageTitle('Detail Aging Hutang Warkat'));
    });
    ...
    return (
        <div style={{ width: '100%', height: '100vh' }}>
            <Viewer reportUri="/report/laporan//hutang-usaha-dan-supplier/detail_hutang_supplierWarkat_byUmur.rdlx-json" reportParam={parameter} hiddenPrint={allowPrint} />
        </div>
    );
};
