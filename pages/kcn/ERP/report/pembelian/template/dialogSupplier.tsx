...
import { swalToast } from '../functional/fungsi';
...
const DialogSupplier: React.FC<DialogDaftarSupplierProps> = ({ kode_entitas, token, visible, dataDaftarSupplier, stateDataFilter, setDataDaftarSupplier, setStateDataFilter, vRefreshData }) => {
    ...
    buttonDaftarSupplier = [
        {
            ...
            click: () => {
                ...
                if (currentDaftarSupplier.length > 0) {
                    ...
                    // }));
                    getNoLpbBySupp(currentDaftarSupplier[0]);
                } else {
    ...
    const getNoLpbBySupp = async (currentDaftarSupplier: any) => {
        setStateDataFilter((prevState: any) => ({
            ...prevState,
            dialogSupplierVisible: false,
