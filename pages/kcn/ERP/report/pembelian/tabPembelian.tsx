...
import { categoriesBukuBesar, categoriesHutangUsahaDanSupplier, categoriesPembelian } from '../model/api';
import BaseDialog from './modal/BaseDialog';
// import BaseDialog from './modal/BaseDialog';
// import { OnClick_CetakDaftarSupplier } from './functional/fungsi';

interface tabPembelianProps {
    userid: any;
    kode_entitas: any;
    sidebarVisible: any;
    token: any;
...
const TabPembelian: React.FC<tabPembelianProps> = ({ userid, kode_entitas, sidebarVisible, token }: tabPembelianProps) => {
            ...
            >
                <div className="flex h-full flex-col">
                    ...
                    <div className="flex items-center justify-between border-b border-gray-300 px-4 py-2">
                        ...
                        <span className="text-right font-bold">Daftar Laporan Pembelian</span>
                    </div>
                    <div className="flex-1 overflow-auto px-4 pt-4">
                        <div>
                            {categoriesPembelian.map((category, index) => (
                                <div
                                    key={category.id}
                    ...
                    <div className="border-t border-gray-300 px-4 py-2">
                        ...
                        <div className="mt-1 text-sm font-bold text-[#9f9a9a]">Menampilkan laporan pembelian.</div>
                    </div>
                </div>
                {/*============================================================================*/}
