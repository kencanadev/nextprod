...
const ReportPage = () => {
    ...
    useEffect(() => {
        dispatch(setPageTitle('Daftar Penerimaan Barang'));
    });
    ...
    return (
        <div style={{ width: '100%', height: '100vh' }}>
            <Viewer reportUri="/report/laporan//pembelian/daftar_penerimaan_barang_outstanding.rdlx-json" reportParam={parameter} hiddenPrint={allowPrint} />
        </div>
    );
};
