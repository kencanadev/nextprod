...
const ReportPage = () => {
    ...
    useEffect(() => {
        dispatch(setPageTitle('Daftar Rincian Permintaan Pembelian'));
    });
    ...
    return (
        <div style={{ width: '100%', height: '100vh' }}>
            <Viewer reportUri="/report/laporan//pembelian/rincian_permintaan_pembelian.rdlx-json" reportParam={parameter} hiddenPrint={allowPrint} />
        </div>
    );
};
