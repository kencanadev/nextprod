...
const ReportPage = () => {
    ...
    const [param18, setKuantitas] = useState('');
    ...
    useEffect(() => {
        ...
        const kuantitas = params.get('kuantitas');
    ...
    useEffect(() => {
        dispatch(setPageTitle('Laporan Pembelian'));
    });
    ...
    return (
        <div style={{ width: '100%', height: '100vh' }}>
            <Viewer reportUri="/report/laporan//pembelian/laporan_pembelian.rdlx-json" reportParam={parameter} hiddenPrint={allowPrint} />
        </div>
    );
};
