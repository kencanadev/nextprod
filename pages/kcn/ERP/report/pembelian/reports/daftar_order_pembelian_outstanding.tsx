...
const ReportPage = () => {
    ...
    const [param18, setSelectedOd] = useState('');
    ...
    useEffect(() => {
        dispatch(setPageTitle('Order Pembelian Outstanding'));
    });
    ...
    return (
        <div style={{ width: '100%', height: '100vh' }}>
            <Viewer reportUri="/report/laporan//pembelian/order_pembelian_outstanding.rdlx-json" reportParam={parameter} hiddenPrint={allowPrint} />
        </div>
    );
};
