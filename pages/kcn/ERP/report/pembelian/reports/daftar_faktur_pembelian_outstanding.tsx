...
const ReportPage = () => {
    ...
    useEffect(() => {
        dispatch(setPageTitle('Daftar Faktur Pembelian Outstanding'));
    });
    ...
    return (
        <div style={{ width: '100%', height: '100vh' }}>
            <Viewer reportUri="/report/laporan//pembelian/daftar_faktur_pembelian_outstanding.rdlx-json" reportParam={parameter} hiddenPrint={allowPrint} />
        </div>
    );
};
