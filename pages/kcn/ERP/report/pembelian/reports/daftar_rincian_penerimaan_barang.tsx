...
const ReportPage = () => {
    ...
    const [param18, setNoPb] = useState('');
    const [param19, setGrupPerDokumen] = useState('');
    ...
    useEffect(() => {
        ...
        const noPb = params.get('noPb');
        const grupPerDokumen = params.get('grupPerDokumen');
        ...
        if (grupPerDokumen !== null) {
            setGrupPerDokumen(grupPerDokumen);
        }
    ...
    useEffect(() => {
        dispatch(setPageTitle('Rincian LPB'));
    });
    ...
    return (
        <div style={{ width: '100%', height: '100vh' }}>
            <Viewer reportUri="/report/laporan//pembelian/rincian_penerimaan_barang.rdlx-json" reportParam={parameter} hiddenPrint={allowPrint} />
        </div>
    );
};
