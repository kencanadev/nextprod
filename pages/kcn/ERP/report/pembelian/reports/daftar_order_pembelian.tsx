...
const ReportPage = () => {
    ...
    useEffect(() => {
        dispatch(setPageTitle('Daftar Order Pembelian'));
    });
    ...
    return (
        <div style={{ width: '100%', height: '100vh' }}>
            <Viewer reportUri="/report/laporan//pembelian/daftar_order_pemblian.rdlx-json" reportParam={parameter} hiddenPrint={allowPrint} />
        </div>
    );
};
