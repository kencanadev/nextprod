...
const ReportPage = () => {
    ...
    useEffect(() => {
        dispatch(setPageTitle('Daftar Rincian Order Pembelian'));
    });
    ...
    return (
        <div style={{ width: '100%', height: '100vh' }}>
            <Viewer reportUri="/report/laporan//pembelian/rincian_order_pembelian.rdlx-json" reportParam={parameter} hiddenPrint={allowPrint} />
        </div>
    );
};
