...
const ReportPage = () => {
    ...
    useEffect(() => {
        dispatch(setPageTitle('Daftar Memo Pengembalian Barang Outstanding'));
    });
    ...
    return (
        <div style={{ width: '100%', height: '100vh' }}>
            <Viewer reportUri="/report/laporan//pembelian/daftar_memo_pengembalian_barang_outstanding.rdlx-json" reportParam={parameter} hiddenPrint={allowPrint} />
        </div>
    );
};
