...
const ReportPage = () => {
    ...
    const [param3, setKodeSupplierValue] = useState('');
    ...
    useEffect(() => {
        ...
        const kodeSupplierValue = params.get('kodeSupplierValue');
        ...
        if (kodeSupplierValue !== null) {
            setKodeSupplierValue(kodeSupplierValue);
        }
    ...
    useEffect(() => {
        dispatch(setPageTitle('Daftar Penerimaan Barang Per Supplier'));
    });
    ...
    return (
        <div style={{ width: '100%', height: '100vh' }}>
            <Viewer reportUri="/report/laporan//pembelian/daftar_penerimaan_barang_per_supplier.rdlx-json" reportParam={parameter} hiddenPrint={allowPrint} />
        </div>
    );
};
