...
const ReportPage = () => {
    ...
    useEffect(() => {
        dispatch(setPageTitle('Daftar Pembelian Per Supplier'));
    });
    ...
    return (
        <div style={{ width: '100%', height: '100vh' }}>
            <Viewer reportUri="/report/laporan//pembelian/laporan_pembelian_per_supplier.rdlx-json" reportParam={parameter} hiddenPrint={allowPrint} />
        </div>
    );
};
