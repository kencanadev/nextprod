...
const ReportPage = () => {
    ...
    useEffect(() => {
        dispatch(setPageTitle('Pembelian Per Kelompok Barang Periode Berjalan'));
    });
    ...
    return (
        <div style={{ width: '100%', height: '100vh' }}>
            <Viewer reportUri="/report/laporan//pembelian/daftar_beli_per_kelompok_barang_periode_berjalan.rdlx-json" reportParam={parameter} hiddenPrint={allowPrint} />
        </div>
    );
};
