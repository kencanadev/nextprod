...
const ReportPage = () => {
    ...
    const [param1, setTglAkhir] = useState('');
    ...
    useEffect(() => {
        dispatch(setPageTitle('Daftar Beli Per Kelompok Barang'));
    });
    ...
    return (
        <div style={{ width: '100%', height: '100vh' }}>
            <Viewer reportUri="/report/laporan//pembelian/daftar_beli_per_kelompok_barang.rdlx-json" reportParam={parameter} hiddenPrint={allowPrint} />
        </div>
    );
};
