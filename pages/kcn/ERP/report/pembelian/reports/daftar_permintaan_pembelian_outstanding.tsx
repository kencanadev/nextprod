...
const ReportPage = () => {
    ...
    const [param17, setTglAwal] = useState('');
    const [param18, setTglAkhir] = useState('');
    ...
    useEffect(() => {
        dispatch(setPageTitle('Permintaan Pembelian Outstanding'));
    });
    ...
    return (
        <div style={{ width: '100%', height: '100vh' }}>
            <Viewer reportUri="/report/laporan//pembelian/permintaan_pembelian_outstanding.rdlx-json" reportParam={parameter} hiddenPrint={allowPrint} />
        </div>
    );
};
