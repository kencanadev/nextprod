...
import TabPembelian from './pembelian/tabPembelian';
enableRipple(true);
        ...
        <div className="Main" id="main-target">
            <div>
                ...
                <div className="flex">
                    ...
                    {stateDataHeader.tipeParams === '70100' ? <TabPembelian userid={userid} kode_entitas={kode_entitas} sidebarVisible={sidebarVisible} token={token} /> : null}
