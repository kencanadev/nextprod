        ...
        <div className="p-2">
            <div className="flex w-full flex-col gap-0.5">
                <div className="flex w-[50%] items-center justify-between">
                    <div className="flex items-center gap-x-2">
                        <label htmlFor="kategori" className="block w-[190px] text-right text-xs font-medium text-gray-900 dark:text-white">
                            Kategori
                        </label>
                    ...
                    <div className="flex items-center gap-x-2">
                        <label htmlFor="satuan" className="block w-[100px] text-right text-xs font-medium text-gray-900 dark:text-white">
                            Satuan Standar
                        </label>
                ...
                <div className="flex w-[50%] items-center justify-between">
                    <div className="flex w-[50%] items-center gap-x-2">
                        <label htmlFor="kelompok-produk" className="block w-[170px] text-right text-xs font-medium text-gray-900 dark:text-white">
                            Kelompok Produk
                        </label>
                        <div className="w-full rounded border border-gray-300 px-2">
                            <ComboBoxComponent
                    ...
                    <div className="flex w-[50%] items-center gap-x-2">
                        <label htmlFor="merek-produk" className="block w-[85px] text-right text-xs font-medium text-gray-900 dark:text-white">
                            Merek Produk
                        </label>
                        <div className="w-full rounded border border-gray-300 px-2">
                            <ComboBoxComponent
                ...
                <div className="flex w-[50%] items-center gap-x-2">
                    <label htmlFor="grup-barang" className="block w-[140px] text-right text-xs font-medium text-gray-900 dark:text-white">
                        Grup Barang
                    </label>
                    <div className="flex w-full items-center rounded border border-gray-300 px-2" onClick={() => setShowGrupBarang(true)}>
                        <TextBoxComponent
                            name="grup-barang"
                            ...
                            readOnly
                        />
                        <button id="grupBarang" className="flex items-center justify-center font-semibold" onClick={() => setShowGrupBarang(true)}>
            ...
            <div className="flex w-[50%] flex-col gap-0.5">
                <div className="flex items-center justify-between">
                    <div className="flex items-center gap-x-2">
                        <label htmlFor="harga-penjualan" className="block w-[200px] text-right text-xs font-medium text-gray-900 dark:text-white">
                            Harga Penjualan (PL)
                        </label>
                        <div className="w-full rounded border border-gray-300 px-2">
                            <TextBoxComponent
                    ...
                    <div className="flex items-center gap-x-2">
                        <label htmlFor="diskon" className="block w-[200px] text-right text-xs font-medium text-gray-900 dark:text-white">
                            Diskon (%)
                        </label>
                        <div className="w-full rounded border border-gray-300 px-2">
                            <TextBoxComponent
                                ...
                                placeholder="Diskon (%)"
                                floatLabelType="Never"
                                value={formState?.diskon}
                                type="number"
                                onChange={(e: any) => updateState('diskon', e.target.value)}
                            />
                        </div>
                    </div>
                </div>
                <div className="flex items-center justify-between">
                    <div className="flex items-center gap-x-2">
                        <label htmlFor="potongan" className="block w-[200px] text-right text-xs font-medium text-gray-900 dark:text-white">
                            Potongan (Rp)
                        </label>
                        <div className="w-full rounded border border-gray-300 px-2">
                            <TextBoxComponent
                    ...
                    <div className="flex items-center gap-x-2">
                        <label htmlFor="pajak" className="block w-[145px] text-right text-xs font-medium text-gray-900 dark:text-white">
                            Pajak
                        </label>
                        <div className="w-full rounded border border-gray-300 px-2">
                            <ComboBoxComponent
                ...
                <div className="flex flex-col">
                    <label htmlFor="faktur" className="block text-xs font-medium text-red-500 underline dark:text-white">
            ...
            <div className="flex w-[50%] gap-0.5">
                {/* Left Side */}
                {/* <div className="grid grid-cols-2 place-content-start gap-x-4"> */}
                <div className="flex w-full flex-col">
                    <div className="flex items-center gap-x-2">
                        <label htmlFor="stok-minimal" className="block w-[190px] text-right text-xs font-medium text-gray-900 dark:text-white">
                            Stok Minimal
                        </label>
                        <div className="w-full rounded border border-gray-300 px-2">
                            <TextBoxComponent
                    ...
                    <div className="flex items-center gap-x-2">
                        <label htmlFor="stok-maksimal" className="block w-[190px] text-right text-xs font-medium text-gray-900 dark:text-white">
                            Stok Maksimal
                        </label>
                        <div className="w-full rounded border border-gray-300 px-2">
                            <TextBoxComponent
                    ...
                    <div className="flex items-center gap-x-2">
                        <label htmlFor="min-order" className="block w-[190px] text-right text-xs font-medium text-gray-900 dark:text-white">
                            Min. Jml Reorder
                        </label>
                        <div className="w-full rounded border border-gray-300 px-2">
                            <TextBoxComponent
                    ...
                    <div className="flex items-center gap-x-2">
                        <label htmlFor="merek-produk" className="block w-[190px] text-right text-xs font-medium text-gray-900 dark:text-white">
                            Prioritas Stok
                        </label>
                        <div className="w-full rounded border border-gray-300 px-2">
                            <ComboBoxComponent
                ...
                <div className="flex w-full flex-col">
                    <div className="flex items-center gap-x-2">
                        <label htmlFor="stok-minimal" className="block w-[235px] text-right text-xs font-medium text-gray-900 dark:text-white">
                            Harga Pembelian (PL)
                        </label>
                        <div className="w-full rounded border border-gray-300 px-2">
                            <TextBoxComponent
                    ...
                    <div className="flex items-center gap-x-2">
                        <label htmlFor="stok-maksimal" className="block w-[235px] text-right text-xs font-medium text-gray-900 dark:text-white">
                            Diskon
                        </label>
                        <div className="w-full rounded border border-gray-300 px-2">
                            <TextBoxComponent
                                ...
                                placeholder="Diskon"
                                floatLabelType="Never"
                                value={formState?.kustom1}
                                onChange={(e: any) => updateState('kustom1', e.target.value)}
                            />
                        </div>
                    </div>
                    <div className="flex items-center gap-x-2">
                        <label htmlFor="min-order" className="block w-[235px] text-right text-xs font-medium text-gray-900 dark:text-white">
                            HPP Standar
                        </label>
                        <div className="w-full rounded border border-gray-300 px-2">
                            <TextBoxComponent
                    ...
                    <div className="flex items-center gap-x-2">
                        <label htmlFor="estimasi" className="block w-[235px] text-right text-xs font-medium text-gray-900 dark:text-white">
