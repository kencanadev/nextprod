        ...
        <div className="mt-3">
            ...
            <div className="w-full rounded border border-gray-300 px-2">
                <ComboBoxComponent
                    ...
                    value={rumus}
                    onChange={(e: any) => setRumus('rumus', e.value)}
                />
            </div>
        </div>
    </div>
            ...
            <div>
                        ...
                        <div className="flex w-full items-center gap-3">
                            <div className="w-full rounded border border-gray-300 px-2">
                                <TextBoxComponent
                                    ...
                                    value={formState?.tebal}
                                    onChange={(e: any) => updateState('tebal', e.target.value)}
                                />
                            </div>
                        ...
                        <div className="flex w-full items-center gap-3">
                            <div className="w-full rounded border border-gray-300 px-2">
                                <TextBoxComponent
                                    ...
                                    floatLabelType="Never"
                                    value={formState?.berat}
                                    onChange={(e: any) => updateState('berat', e.target.value)}
                                />
                            </div>
                        ...
                        <div className="flex w-full items-center gap-3">
                            <div className="w-full rounded border border-gray-300 px-2">
                                <TextBoxComponent
                                    ...
                                    onChange={(e: any) => updateState('panjang', e.target.value)}
                                />
                            </div>
                ...
                <AccordionComponent expandMode="Single">
                    <AccordionItemsDirective>
                        <AccordionItemDirective expanded={false} header={`Rumus Perhitungan Berat : ${item}`} content={() => <TabelRumus rumus={formState?.rumus} setRumus={updateState} />} />
                    </AccordionItemsDirective>
                </AccordionComponent>
                ...
                <div className="mt-3 grid grid-cols-4 gap-x-6">
                    <div className="flex items-center gap-x-0">
                        ...
                        <div className="flex w-full items-center gap-3">
                            <div className="w-full rounded border border-gray-300 px-2">
                                <TextBoxComponent
                                    name="berat"
                                    placeholder="Berat Tabel (Kg)"
                                    floatLabelType="Never"
                                    value={formState?.berat_tabel}
                                    onChange={(e: any) => updateState('berat_tabel', e.target.value)}
                                />
                            </div>
                    ...
                    <div className="flex items-center gap-x-0">
                        ...
                        <div className="flex w-full items-center gap-3">
                            <div className={`${formState?.rumus === 0 ? '' : 'bg-[#DCDCDC]'} w-full rounded border border-gray-300 px-2`}>
                                <TextBoxComponent
                                    name="berat-toleransi-1"
                                    placeholder="Berat Standar / Toleransi 0.1 (Kg)"
                                    floatLabelType="Never"
                                    value={formState?.berat_01}
                                    onChange={(e: any) => updateState('berat1', e.target.value)}
                                    style={{
                                        cursor: formState?.rumus === 0 ? 'text' : 'not-allowed',
                                    }}
                                    disabled={formState?.rumus !== 0}
                                />
                            </div>
