...
const forDialogAndSwallOriKendaraanMaster = ({
    ...
    const handleTgl = async (date: any, tipe: string) => {
        if (tipe === 'tgl_berlaku_stnk') {
            setInformasiState((oldData: any) => ({
                ...oldData,
                tgl_berlaku_stnk: moment(date).format('YYYY-MM-DD HH:mm:ss'),
            }));
        } else if (tipe === 'tgl_berlaku_pajak') {
            setInformasiState((oldData: any) => ({
                ...oldData,
                tgl_berlaku_pajak: moment(date).format('YYYY-MM-DD HH:mm:ss'),
            }));
        } else if (tipe === 'tgl_registrasi_kir') {
            setInformasiState((oldData: any) => ({
                ...oldData,
                tgl_registrasi_kir: moment(date).format('YYYY-MM-DD HH:mm:ss'),
            }));
        } else if (tipe === 'tgl_beli') {
            setInformasiState((oldData: any) => ({
                ...oldData,
                tgl_beli: moment(date).format('YYYY-MM-DD HH:mm:ss'),
            }));
        } else if (tipe === 'tgl_operasional_awal') {
            setInformasiState((oldData: any) => ({
                ...oldData,
                tgl_operasional_awal: moment(date).format('YYYY-MM-DD HH:mm:ss'),
            }));
        } else if (tipe === 'tgl_jatuh_tempo_asuransi') {
            setLainLainState((oldData: any) => ({
                ...oldData,
                tgl_jatuh_tempo_asuransi: moment(date).format('YYYY-MM-DD HH:mm:ss'),
            }));
        } else if (tipe === 'tgl_asuransi') {
            setLainLainState((oldData: any) => ({
                ...oldData,
                tgl_asuransi: moment(date).format('YYYY-MM-DD HH:mm:ss'),
            }));
        } else if (tipe === 'tgl_jatuh_tempo') {
            setLainLainState((oldData: any) => ({
                ...oldData,
                tgl_jatuh_tempo: moment(date).format('YYYY-MM-DD HH:mm:ss'),
            }));
        } else if (tipe === 'tgl') {
            setLainLainState((oldData: any) => ({
                ...oldData,
                tgl: moment(date).format('YYYY-MM-DD HH:mm:ss'),
            }));
        } else if (tipe === 'tgl_operasional_akhir') {
            setInformasiState((oldData: any) => ({
                ...oldData,
                tgl_operasional_akhir: moment(date).format('YYYY-MM-DD HH:mm:ss'),
            }));
        }
                        ...
                        <div className="flex">
                            <div>
                                <table className="w-[650px] p-0">
                                    ...
                                    <tr className="border-none">
                                        <td className="text-right text-xs">Alamat</td>
                                        <td className="flex w-[440px]">
                                            <input
                                                type="text"
                                                id="alamat"
                                    ...
                                    <tr className="border-none">
                                        ...
                                        <td className="flex w-[440px] items-center gap-2">
                                            ...
                                            /> */}
                                            <div className="box-border w-[198px] rounded-sm border border-gray-400 bg-gray-50 pl-2">
                                                <DatePickerComponent
                                                    locale="id"
                                                    ...
                                                    format="dd-MM-yyyy"
                                                    width="100%"
                                                    value={moment(informasiState.tgl_berlaku_stnk).isValid() ? moment(informasiState.tgl_berlaku_stnk).toDate() : undefined}
                                                    change={(args: ChangeEventArgsCalendar) => {
                                                        handleTgl(args.value, 'tgl_berlaku_stnk');
                                                    }}
                                            ...
                                            <label htmlFor="biaya_adm_stnk_tnkb" className="flex w-full items-center justify-end gap-2 text-xs">
                                                ...
                                                <input
                                                    ...
                                                    value={
                                                        isFocused.biaya_adm_stnk_tnkb ? hiddenNol(informasiState?.biaya_adm_stnk_tnkb) : formatNumber(hiddenNol(informasiState?.biaya_adm_stnk_tnkb))
                                                    }
                                                    style={{ height: '23px' }}
                                                    onInput={(e: React.ChangeEvent<HTMLInputElement>) => {
                                                        e.target.value = e.target.value.replace(/[^0-9.]/g, ''); // Hapus karakter non-angka
                                        ...
                                        <td className="flex w-[440px] items-center gap-2">
                                            ...
                                            <div className="box-border w-[198px] rounded-sm border border-gray-400 bg-gray-50 pl-2">
                                                <DatePickerComponent
                                                    ...
                                                    format="dd-MM-yyyy"
                                                    width="100%"
                                                    value={moment(informasiState.tgl_berlaku_pajak).isValid() ? moment(informasiState.tgl_berlaku_pajak).toDate() : undefined}
                                                    change={(args: ChangeEventArgsCalendar) => {
                                                        handleTgl(args.value, 'tgl_berlaku_pajak');
                                                    }}
                                                    // style={{border: '1px black solid'}}
                                                >
                                                    <Inject services={[MaskedDateTime]} />
                                        ...
                                        <td className="flex w-[440px] items-center gap-2">
                                            ...
                                            <div className="box-border w-[198px] rounded-sm border border-gray-400 bg-gray-50 pl-2">
                                                <DatePickerComponent
                                                    ...
                                                    format="dd-MM-yyyy"
                                                    width="100%"
                                                    value={moment(informasiState.tgl_registrasi_kir).isValid() ? moment(informasiState.tgl_registrasi_kir).toDate() : undefined}
                                                    change={(args: ChangeEventArgsCalendar) => {
                                                        handleTgl(args.value, 'tgl_registrasi_kir');
                                                    }}
                                                    // style={{border: '1px black solid'}}
                                                >
                                                    <Inject services={[MaskedDateTime]} />
                                            ...
                                            <td className="flex w-[440px] items-center gap-2">
                                                ...
                                                <div className="box-border w-[198px] rounded-sm border border-gray-400 bg-gray-50 pl-2">
                                                    <DatePickerComponent
                                                        ...
                                                        format="dd-MM-yyyy"
                                                        width="100%"
                                                        value={moment(informasiState.tgl_beli).isValid() ? moment(informasiState.tgl_beli).toDate() : undefined}
                                                        change={(args: ChangeEventArgsCalendar) => {
                                                            handleTgl(args.value, 'tgl_beli');
                                                        }}
                                                        // style={{border: '1px black solid'}}
                                                    >
                                                        <Inject services={[MaskedDateTime]} />
                                            ...
                                            <td className="flex w-[440px] items-center gap-2">
                                                ...
                                                <div className="box-border w-[198px] rounded-sm border border-gray-400 bg-gray-50 pl-2">
                                                    <DatePickerComponent
                                                        ...
                                                        format="dd-MM-yyyy"
                                                        width="100%"
                                                        value={moment(informasiState.tgl_operasional_awal).isValid() ? moment(informasiState.tgl_operasional_awal).toDate() : undefined}
                                                        change={(args: ChangeEventArgsCalendar) => {
                                                            handleTgl(args.value, 'tgl_operasional_awal');
                                                        }}
                                                        // style={{border: '1px black solid'}}
                                                    >
                                                        <Inject services={[MaskedDateTime]} />
                                                ...
                                                <label htmlFor="tgl_operasional_akhir" className="flex w-full items-center justify-end gap-2 text-xs">
                                                    ...
                                                    <div className="box-border w-[140px] rounded-sm border border-gray-400 bg-gray-50 pl-2">
                                                        <DatePickerComponent
                                                            locale="id"
                                                            // cssClass="e-custom-style"
                                                            enableMask={true}
                                                            ...
                                                            format="dd-MM-yyyy"
                                                            width="100%"
                                                            value={moment(informasiState.tgl_operasional_akhir).isValid() ? moment(informasiState.tgl_operasional_akhir).toDate() : undefined}
                                                            change={(args: ChangeEventArgsCalendar) => {
                                                                handleTgl(args.value, 'tgl_operasional_akhir');
                                                            }}
                                                            // style={{border: '1px black solid'}}
                                                        >
                                                            <Inject services={[MaskedDateTime]} />
                                        ...
                                        <td className="flex w-[440px] items-center gap-2">
                                            <div className="box-border w-[140px] rounded-sm border border-gray-400 bg-gray-50 pl-2">
                                                <DatePickerComponent
                                                    ...
                                                    format="dd-MM-yyyy"
                                                    width="100%"
                                                    value={moment(lainLainState.tgl).isValid() ? moment(lainLainState.tgl).toDate() : undefined}
                                                    change={(args: ChangeEventArgsCalendar) => {
                                                        handleTgl(args.value, 'tgl');
                                                    }}
                                                    // style={{border: '1px black solid'}}
                                                >
                                                    <Inject services={[MaskedDateTime]} />
                                        ...
                                        <td className="flex w-[440px] items-center gap-2">
                                            <div className="box-border w-[140px] rounded-sm border border-gray-400 bg-gray-50 pl-2">
                                                <DatePickerComponent
                                                    ...
                                                    format="dd-MM-yyyy"
                                                    width="100%"
                                                    value={moment(lainLainState.tgl_jatuh_tempo).isValid() ? moment(lainLainState.tgl_jatuh_tempo).toDate() : undefined}
                                                    change={(args: ChangeEventArgsCalendar) => {
                                                        handleTgl(args.value, 'tgl_jatuh_tempo');
                                                    }}
                                                    // style={{border: '1px black solid'}}
                                                >
                                                    <Inject services={[MaskedDateTime]} />
                                        ...
                                        <td className="flex w-[440px] items-center gap-2">
                                            <div className="box-border w-[140px] rounded-sm border border-gray-400 bg-gray-50 pl-2">
                                                <DatePickerComponent
                                                    ...
                                                    format="dd-MM-yyyy"
                                                    width="100%"
                                                    value={moment(lainLainState.tgl_asuransi).isValid() ? moment(lainLainState.tgl_asuransi).toDate() : undefined}
                                                    change={(args: ChangeEventArgsCalendar) => {
                                                        handleTgl(args.value, 'tgl_asuransi');
                                                    }}
                                                    // style={{border: '1px black solid'}}
                                                >
                                                    <Inject services={[MaskedDateTime]} />
                                        ...
                                        <td className="flex w-[440px] items-center gap-2">
                                            ...
                                            <div className="box-border w-[140px] rounded-sm border border-gray-400 bg-gray-50 pl-2">
                                                <DatePickerComponent
                                                    ...
                                                    format="dd-MM-yyyy"
                                                    width="100%"
                                                    value={moment(lainLainState.tgl_jatuh_tempo_asuransi).isValid() ? moment(lainLainState.tgl_jatuh_tempo_asuransi).toDate() : undefined}
                                                    change={(args: ChangeEventArgsCalendar) => {
                                                        handleTgl(args.value, 'tgl_jatuh_tempo_asuransi');
                                                    }}
                                                    // style={{border: '1px black solid'}}
                                                >
                                                    <Inject services={[MaskedDateTime]} />
