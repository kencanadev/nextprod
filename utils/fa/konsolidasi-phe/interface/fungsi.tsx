...
const CustomSumNettoMuPheBaru = (props: any) => {
    return <span style={{ fontWeight: 'bold' }}>{props.Custom}</span>;
};

const CustomSumBayarMuPheBaru = (props: any) => {
    return <span style={{ fontWeight: 'bold' }}>{props.Custom}</span>;
};

export {
    CustomSumNettoMuPheBaru,
    CustomSumBayarMuPheBaru,
    CustomSumBayarMu,
    editTemplateBayarMu,
    editTemplateSisaHutang,
    editTemplateTotalBerat,
    editTemplateBiayaLain,
    editTemplatePotonganLain,
    editTemplateNettoMu,
    headerJumlahYangAkanDibayar,
};
