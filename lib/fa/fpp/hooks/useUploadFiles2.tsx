...
const useUploadFiles2 = (props: any) => {
    ...
    const handleFileSelect = (args: any, jenis: any) => {
        ...
        if (jenis === 'pengajuan-1') {
            updateStateFiles('nameImage1', 'FP' + moment().format('YYMMDDHHmmss') + '.' + fileExtension);
        } else if (jenis === 'pengajuan-2') {
            updateStateFiles('nameImage2', 'FP' + moment().format('YYMMDDHHmmss') + '.' + fileExtension);
        } else if (jenis === 'pengajuan-3') {
            updateStateFiles('nameImage3', 'FP' + moment().format('YYMMDDHHmmss') + '.' + fileExtension);
        } else if (jenis === 'pengajuan-4') {
            updateStateFiles('nameImage4', 'FP' + moment().format('YYMMDDHHmmss') + '.' + fileExtension);
        } else if (jenis === 'pengajuan-5') {
            updateStateFiles('nameImage5', 'FP' + moment().format('YYMMDDHHmmss') + '.' + fileExtension);
        } else if (jenis === 'pembayaran-1') {
            updateStateFiles('nameImage6', 'FP' + moment().format('YYMMDDHHmmss') + '.' + fileExtension);
        } else if (jenis === 'pembayaran-2') {
            updateStateFiles('nameImage7', 'FP' + moment().format('YYMMDDHHmmss') + '.' + fileExtension);
        } else if (jenis === 'pembayaran-3') {
            updateStateFiles('nameImage8', 'FP' + moment().format('YYMMDDHHmmss') + '.' + fileExtension);
        } else if (jenis === 'pembayaran-4') {
            updateStateFiles('nameImage9', 'FP' + moment().format('YYMMDDHHmmss') + '.' + fileExtension);
        } else if (jenis === 'pembayaran-5') {
            updateStateFiles('nameImage10', 'FP' + moment().format('YYMMDDHHmmss') + '.' + fileExtension);
        }
                ...
                try {
                    ...
                    for (const item of files) {
                        try {
                            ...
                            const namaImage = item.fileName ? 'FP' + moment().format('YYMMDDHHmmssSSS') + '.' + fileExtension : item.fileName;
