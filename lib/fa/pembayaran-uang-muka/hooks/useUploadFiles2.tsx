...
const useUploadFiles2 = (props: any) => {
    ...
    const handleFileSelect = (args: any, jenis: any) => {
        ...
        if (jenis === 'pengajuan-1') {
            updateStateFiles('nameImage1', 'UM' + moment().format('YYMMDDHHmmss') + '.' + fileExtension);
        } else if (jenis === 'pengajuan-2') {
            updateStateFiles('nameImage2', 'UM' + moment().format('YYMMDDHHmmss') + '.' + fileExtension);
        } else if (jenis === 'pengajuan-3') {
            updateStateFiles('nameImage3', 'UM' + moment().format('YYMMDDHHmmss') + '.' + fileExtension);
        } else if (jenis === 'pengajuan-4') {
            updateStateFiles('nameImage4', 'UM' + moment().format('YYMMDDHHmmss') + '.' + fileExtension);
        } else if (jenis === 'pengajuan-5') {
            updateStateFiles('nameImage5', 'UM' + moment().format('YYMMDDHHmmss') + '.' + fileExtension);
        } else if (jenis === 'pembayaran-1') {
            updateStateFiles('nameImage6', 'UM' + moment().format('YYMMDDHHmmss') + '.' + fileExtension);
        } else if (jenis === 'pembayaran-2') {
            updateStateFiles('nameImage7', 'UM' + moment().format('YYMMDDHHmmss') + '.' + fileExtension);
        } else if (jenis === 'pembayaran-3') {
            updateStateFiles('nameImage8', 'UM' + moment().format('YYMMDDHHmmss') + '.' + fileExtension);
        } else if (jenis === 'pembayaran-4') {
            updateStateFiles('nameImage9', 'UM' + moment().format('YYMMDDHHmmss') + '.' + fileExtension);
        } else if (jenis === 'pembayaran-5') {
            updateStateFiles('nameImage10', 'UM' + moment().format('YYMMDDHHmmss') + '.' + fileExtension);
        }
                    ...
                    ? [
                          {
                              ...
                              rawFile: base64ToFile(dataFiles.preview1, dataFiles.nameImage1),
                              fileName: dataFiles.nameImage1,
                              originalName: uploaderRefPengajuan1.current.getFilesData()[0]?.name || dataFiles.nameOriginal1,
                              id: 1,
                          },
                      ]
                    ...
                    ? [
                          {
                              ...
                              rawFile: base64ToFile(dataFiles.preview2, dataFiles.nameImage2),
                              fileName: dataFiles.nameImage2,
                              originalName: uploaderRefPengajuan2.current.getFilesData()[0]?.name || dataFiles.nameOriginal2,
                              id: 2,
                          },
                      ]
                    ...
                    ? [
                          {
                              ...
                              rawFile: base64ToFile(dataFiles.preview3, dataFiles.nameImage3),
                              fileName: dataFiles.nameImage3,
                              originalName: uploaderRefPengajuan3.current.getFilesData()[0]?.name || dataFiles.nameOriginal3,
                              id: 3,
                          },
                      ]
                    ...
                    ? [
                          {
                              ...
                              rawFile: base64ToFile(dataFiles.preview4, dataFiles.nameImage4),
                              fileName: dataFiles.nameImage4,
                              originalName: uploaderRefPengajuan4.current.getFilesData()[0]?.name || dataFiles.nameOriginal4,
                              id: 4,
                          },
                      ]
                    ...
                    ? [
                          {
                              ...
                              rawFile: base64ToFile(dataFiles.preview5, dataFiles.nameImage5),
                              fileName: dataFiles.nameImage5,
                              originalName: uploaderRefPengajuan5.current.getFilesData()[0]?.name || dataFiles.nameOriginal5,
                              id: 5,
                          },
                      ]
                    ...
                    ? [
                          {
                              ...
                              rawFile: base64ToFile(dataFiles.preview6, dataFiles.nameImage6),
                              fileName: dataFiles.nameImage6,
                              originalName: uploaderRefPembayaran1.current.getFilesData()[0]?.name || dataFiles.nameOriginal6,
                              id: 20,
                          },
                      ]
                    ...
                    ? [
                          {
                              ...
                              rawFile: base64ToFile(dataFiles.preview7, dataFiles.nameImage7),
                              fileName: dataFiles.nameImage7,
                              originalName: uploaderRefPembayaran2.current.getFilesData()[0]?.name || dataFiles.nameOriginal7,
                              id: 21,
                          },
                      ]
                    ...
                    ? [
                          {
                              ...
                              rawFile: base64ToFile(dataFiles.preview8, dataFiles.nameImage8),
                              fileName: dataFiles.nameImage8,
                              originalName: uploaderRefPembayaran3.current.getFilesData()[0]?.name || dataFiles.nameOriginal8,
                              id: 22,
                          },
                      ]
                    ...
                    ? [
                          {
                              ...
                              rawFile: base64ToFile(dataFiles.preview9, dataFiles.nameImage9),
                              fileName: dataFiles.nameImage9,
                              originalName: uploaderRefPembayaran4.current.getFilesData()[0]?.name || dataFiles.nameOriginal9,
                              id: 23,
                          },
                      ]
                    ...
                    ? [
                          {
                              ...
                              rawFile: base64ToFile(dataFiles.preview10, dataFiles.nameImage10),
                              fileName: dataFiles.nameImage10,
                              originalName: uploaderRefPembayaran5.current.getFilesData()[0]?.name || dataFiles.nameOriginal10,
                              id: 24,
                          },
                      ]
                ...
                try {
                    ...
                    for (const item of files) {
                        try {
                            ...
                            const fileExtension = item.fileName.slice(lastDotIndex + 1).toLowerCase();
                            const namaImage = item.fileName ? 'UM' + moment().format('YYMMDDHHmmssSSS') + '.' + fileExtension : item.fileName;
                            ...
                            if (response.status === 200) {
                                try {
                                    await axios.delete(`${apiUrl}/erp/hapus_file_pendukung_ftp`, {
                                        params: {
                                            entitas: kode_entitas,
                                            param1: item.fileName,
                                        },
                                    });
                                } catch {
                                    console.error('Error deleting FTP File: ', item.fileName);
                                }
                                ...
                                console.error('Failed item:', item.fileName);
                            }
                        } catch (error) {
                            const json = {
                                entitas: kode_entitas,
                    ...
                    try {
                        ...
                        await axios.post(`${apiUrl}/erp/simpan_tbimages`, combinedArray);
                    } catch (error) {
