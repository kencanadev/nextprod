...
const FppHandlerContextFnB = createContext<FppHandlerContextType | undefined>(undefined);

export const FppHandlerProviderFnB = ({ children }: { children: React.ReactNode }) => {
...
export const useFppHandlerContextFnB = () => {
    const context = useContext(FppHandlerContextFnB);
    if (!context) {
