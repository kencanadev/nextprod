    ...
    return (
        <App>
            ...
            <div className="relative">
                ...
                <div className={`${themeConfig.navbar} main-container !max-h-screen text-black dark:text-white-dark`} id="main-target">
                    {/* BEGIN SIDEBAR */}
                    <Sidebar />
                    {/* END SIDEBAR */}
                    <div id="master-layout" className="main-content flex h-screen flex-col justify-between">
                        {/* BEGIN TOP NAVBAR */}
                        <Header />
                        {/* END TOP NAVBAR */}

                        {/* BEGIN CONTENT AREA */}
                        <div className={`${animation} animate__animated h-[calc(100%-200px)] flex-1 p-6`}>{children}</div>
                        {/* END CONTENT AREA */}
